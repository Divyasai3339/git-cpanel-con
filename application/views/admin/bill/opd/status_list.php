            ...
            <div class="col-md-12">
                <div class="box box-primary"> 
                    <div class="box-header with-border">
                        ...
                        <span class="box-title titlefix" style="float:left;font-weight:bold;">Patient Status</span> &nbsp;&nbsp;&nbsp;&nbsp;
                        <div style="height:20px; width:20px;float:left;margin-left:20px;font-size:15px;">Waiting</div>&nbsp;<div style="height:20px; width:20px; background:#fcba03;float:left;margin-left:30px;"></div>
                        <div style="height:20px; width:20px;float:left;margin-left:20px;font-size:15px;">AR</div>&nbsp;<div style="height:20px; width:20px; background:red;float:left;"></div>
                        <div style="height:20px; width:20px;float:left;margin-left:20px;font-size:15px;">OPT</div>&nbsp;<div style="height:20px; width:20px; background:blue;float:left;margin-left:10px;"></div>
                        <div style="height:20px; width:20px;float:left;margin-left:20px;font-size:15px;">Doctor</div>&nbsp;<div style="height:20px; width:20px; background:#720455;float:left;margin-left:25px;"></div>
                        <div style="height:20px; width:20px;float:left;margin-left:20px;font-size:15px;">Dilation</div>&nbsp;<div style="height:20px; width:20px; background:#5f64e8;float:left;margin-left:30px;"></div>
                        <div style="height:20px; width:20px;float:left;margin-left:20px;font-size:15px;">Investigation</div>&nbsp;<div style="height:20px; width:20px; background:#0C7B93;float:left;margin-left:65px;"></div>
                        </div>
                        ...
                        <div class="box-tools addmeeting box-tools-md">
                                ...
                                <a href="<?php echo base_url("admin/patient/status/list"); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Patient Status</a> -->
                                    ...
                                    <option value=""><?php echo $this->lang->line('select')?></option>
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('discount') ?></label><small class="req"> *</small><input type="text" onkeyup="amount_settlement(this.value)" name="discount"  id="discount" class="form-control">    
...
<script type="text/javascript">
    ...
    $(document).on('click','.patient_checkout',function(){

        if (confirm('Do you want checkout this patient ?')) {
        ...
        var id=$(this).data('id');
        $.ajax({
            url: base_url+'admin/bill/updatePatientStatusCnt',
            type: "POST",
            data:{'opd_id':id,'action':'checkout'},
            dataType: 'json',
    ...
    $(document).on('click','.patient_not_avail',function(){
        var id=$(this).data('id');
        $.ajax({
            url: base_url+'admin/bill/updatePatientStatusCnt',
            type: "POST",
            data:{'opd_id':id,'action':'not_avail'},
            dataType: 'json',
            success: function (res) {
                successMsg(res);
            },
    ...
    $(document).on('click','.patient_avail',function(){
        var id=$(this).data('id');
        $.ajax({
            url: base_url+'admin/bill/updatePatientStatusCnt',
            type: "POST",
            data:{'opd_id':id,'action':'available'},
            dataType: 'json',
            success: function (res) {
                successMsg(res);
            },
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/bill/patient_status_list',[],[],100);
    });
} ( jQuery ) )
</script>
<!-- //========datatable end===== -->
 <?php $this->load->view('admin/patient/patientaddmodal'); ?>
  ...
  <script>
 function amount_settlement(discount){
    var standard_charge =  $('#standard_charge').val(); 
    var discounted_amount  = standard_charge - discount ;
    $('#paid_amount').val(discounted_amount);
    $('#apply_charge').val(discounted_amount);
    $('#apply_amount').val(discounted_amount);
}
 </script>