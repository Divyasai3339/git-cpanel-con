            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo "IOL Model List"; ?></h3>
                        <div class="box-tools pull-right">
                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm addcategory"><i class="fa fa-plus"></i>  <?php echo "Add IOL Model"; ?></a>                           
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="download_label"><?php echo "IOL Model List"; ?></div>
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped table-bordered example">
                                ...
                                <tbody>
                                    <?php
if (!empty($iolmodel_list)) {  
                                        
    foreach ($iolmodel_list as $key => $value) {
        ?>
                                            <tr>
                                                <td class="mailbox-name"> <?php echo $value['iolmodel_name'] ?>  </td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/operationtheatre/addiolmodel') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="pwd"><?php echo 'IOL Model'; ?></label> <small class="req"> *</small>
                            <input class="form-control" id="iolmodel_name" name="iolmodel_name" value="<?php echo set_value('iolmodel'); ?>"/>
                            <span class="text-danger"><?php echo form_error('iolmodel_name'); ?></span>
...
<script>
    ...
    function get(id) {
        $("#modaltitle").html('<?php echo "Edit IOL Model"; ?>');
        $('#myModal').modal('show');

        $.ajax({
            dataType: 'json',
            url: '<?php echo base_url(); ?>admin/operationtheatre/getiolmodel/' + id,
            success: function (result) {
                $('#id').val(result.id);
                $('#iolmodel_name').val(result.iolmodel_name);
...
$(".addcategory").click(function(){
    $("#modaltitle").html('<?php  echo "Add IOL Model"; ?>');
...
<script>
     function delete_recordById(id) {
              ...
              if (confirm(<?php echo "'" . $this->lang->line('delete_confirm') . "'"; ?>)) {
                    $.ajax({
                        url: '<?php echo base_url()."admin/operationtheatre/deleteiolmodel"; ?>',
                        data:{id:id},
                        type:"post",
