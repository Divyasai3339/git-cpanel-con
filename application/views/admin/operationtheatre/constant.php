            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo "A Constant List"; ?></h3>
                        <div class="box-tools pull-right">
                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm addcategory"><i class="fa fa-plus"></i>  <?php echo "Add A Constant"; ?></a>                           
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="download_label"><?php echo "A Constant List"; ?></div>
...
if (!empty($constant_list)) {  
    ...
    foreach ($constant_list as $key => $value) {
        ?>
                                            <tr>
                                                <td class="mailbox-name"> <?php echo $value['constant_name'] ?>  </td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/operationtheatre/addconstant') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="pwd"><?php echo 'A Constant'; ?></label> <small class="req"> *</small>
                            <input class="form-control" id="constant_name" name="constant_name" value="<?php echo set_value('constant'); ?>"/>
...
<script>
    ...
    function get(id) {
        $("#modaltitle").html('<?php echo "Edit A Constant"; ?>');
        $('#myModal').modal('show');

        $.ajax({
            dataType: 'json',
            url: '<?php echo base_url(); ?>admin/operationtheatre/getconstant/' + id,
            success: function (result) {
                $('#id').val(result.id);
                $('#constant_name').val(result.constant_name);
...
$(".addcategory").click(function(){
    $("#modaltitle").html('<?php  echo "Add A Constant"; ?>');
...
<script>
     function delete_recordById(id) {
              ...
              if (confirm(<?php echo "'" . $this->lang->line('delete_confirm') . "'"; ?>)) {
                    $.ajax({
                        url: '<?php echo base_url()."admin/operationtheatre/deleteconstant"; ?>',
                        data:{id:id},
                        type:"post",
