...
<div class="row">
        <div class="col-md-12">
            <?php if (!empty($print_details[0]['print_header'])) { ?>
                        <div class="pprinta4">
                            <img src="https://drgenielive.com/demo/uploads/printing/img1.jpeg" class="img-responsive" style="height:100px; width: 100%;">
                            <?php
            ...
            <div class="card">
                <div class="card-body">  
                    <div class="row">
                        <div class="col-md-6">                            
                            <p class="fnt"><span><?php echo $this->lang->line("bill_no"); ?> :</span> <?php echo $bill_prefix.$result->id; ?></p>
                            <p class="fnt"><span><?php echo $this->lang->line('patient'); ?>:</span> <?php echo composePatientName($result->patient_name,$result->patient_id); ?></p>
                            <p class="fnt"><span><?php echo $this->lang->line('case_id'); ?> :</span> <?php echo $result->case_reference_id; ?></p>
                            <p class="fnt"><span><?php echo $this->lang->line('prescription_no'); ?> :</span> <?php echo $prescription; ?></p>
                            <p class="fnt"><span><?php echo $this->lang->line("age"); ?> :</span> <?php echo $this->customlib->getPatientAge($result->age,$result->month,$result->day); ?></p>
                            <p class="fnt"><span><?php echo $this->lang->line("gender"); ?> :</span> <?php echo $result->gender; ?></p>
                        ...
                        <div class="col-md-6 text-right">                                             
                         <p class="fnt"><span><?php echo $this->lang->line('date'); ?>: </span> <?php echo $this->customlib->YYYYMMDDHisTodateFormat($result->date, $this->customlib->getHospitalTimeFormat()); ?></p>
                         <p class="fnt"><span><?php echo $this->lang->line("phone"); ?> :</span> <?php echo $result->mobileno; ?></p>
                            <p class="fnt"><span><?php echo $this->lang->line("address"); ?> :</span> <?php echo $result->address; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <tr>
                               ...
                               <!-- <td class="text-right">-->
                               <!-- <?php echo"(".$report_value->tax_percentage."%)".calculatePercent($report_value->apply_charge,$report_value->tax_percentage); ?>-->
                               <!--</td>-->
                    ...
                    $row_counter++;
                        ...
                        ?> 
                                ...
                                <!--   <td class="text-right no-line"><strong>-->
                                   ...
                                   <!--<td class="text-right no-line"><strong>-->
                                       <?php 
                                    //   echo $currency_symbol . "" . amountFormat($tax_amt); 
                                       ?>
                                <!--       </strong></td>-->
                                <!--</tr>-->
                                   <tr>
                                ...
                                <!--   <td class="text-right no-line"><strong>-->
                                       <?php 
                                    //   echo $this->lang->line('total_due'); 
                                       ?>
                                   <!--    </strong></td>-->
                                   <!--<td class="text-right no-line"><strong>-->
                                       <?php 
                                    //   echo $currency_symbol . "" . amountFormat($result->net_amount-$result->total_deposit); 
                                       ?>
                                       <!--</strong></td>-->
                                <!--</tr>-->
                             </tbody>
