...
<div class="row">
           ...
           <?php if (!empty($print_details[0]['print_header'])) { ?>
            ...
            <div class="card">
                <div class="card-body">  
                    <div class="row">
                        <div class="col-md-6">                          
                            <p><span class="font-bold"><?php echo $this->lang->line(''); ?>: </span> <?php echo $this->customlib->getSessionPrefixByType('radiology_billing').$head_result->id; ?></p>
      ...
      <!--<?php echo "(".$row['short_name'].")"; ?>-->
                             ...
                             <thead>
                                <tr class="line">
                                   <td><strong>#</strong></td>
                                   <td class="text-left"><strong><?php echo $this->lang->line('test_parameter_name'); ?></strong></td>                         <td class="text-center"><strong><?php echo $this->lang->line('report_value'); ?></strong></td>       
                                   <td class="text-right"><strong><?php echo $this->lang->line('reference_range'); ?></strong></td>
