                                        ...
                                        <table class="table table-bordered table_acceptance">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name='nt_od_time_bf' id="nt_od_time_bf" class="form-control  nt_od_time_bf" style="width:100%">
                                                </td>
                                                </tr>
                                                <tr>
                                                    <th class="head">OS</th>
                                                    ...
                                                    <td>
                                                        <input type="text" name='nt_os_time_bf' id="nt_os_time_bf" class="form-control  nt_os_time_bf" style="width:100%">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>            
                                        ...
                                        <table class="table table-bordered table_acceptance">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name='at_od_time_bf' id="at_od_time_bf" class="form-control  at_od_time_bf" style="width:100%">
                                                </td>
                                                </tr>
                                                <tr>
                                                    <th class="head">OS</th>
                                                    ...
                                                    <td>
                                                        <input type="text" name='at_os_time_bf' id="at_os_time_bf" class="form-control  at_os_time_bf" style="width:100%">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>            
                                ...
                                <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="head">OD</th>
                                            <td>
                                                <input type="text" name='kera_od_ha1' id="kera_od_ha1" class="form-control  kera_od_ha1" style="width:100%">
                                            </td>
                                            <td>
                                                <span style="width:1%">@</span>
                                            </td>
                                            <td>
                                                <input type="text" name='kera_od_ha2' id="kera_od_ha2" class="form-control  kera_od_ha2" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='kera_od_va1' id="kera_od_va1" class="form-control  kera_od_va1" style="width:100%">
                                            </td>
                                            <td>
                                                <span style="width:1%">@</span>
                                            </td>
                                            <td>
                                                <input type="text" name='kera_od_va2' id="kera_od_va2" class="form-control  kera_od_va2" style="width:100%">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="head">OS</th>
                                            <td>
                                                <input type="text" name='kera_os_ha1' id="kera_os_ha1" class="form-control  kera_os_ha1" style="width:100%">
                                            </td>
                                            <td>
                                                <span style="width:1%">@</span>
                                            </td>
                                            <td>
                                                <input type="text" name='kera_os_ha2' id="kera_os_ha2" class="form-control  kera_os_ha2" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='kera_os_va1' id="kera_os_va1" class="form-control  kera_os_va1" style="width:100%">
                                            </td>
                                            <td>
                                                <span style="width:1%">@</span>
                                            </td>
                                            <td>
                                                <input type="text" name='kera_os_va2' id="kera_os_va2" class="form-control  kera_os_va2" style="width:100%">
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table_visions">
                                    ...
                                    <tr>
                                        <th class="head">OD</th>
                                        <td>
                                            <select name='wat_od' id="wat_od" class="form-control select2 wat_od" style="width:100%">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                        ...
                                        <td>
                                            <select name='reg_od' id="reg_od" class="form-control select2 reg_od" style="width:100%">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                                <option value="Yes">Yes</option>
                                        ...
                                        <td>
                                            <select name='dis_od' id="dis_od" class="form-control select2 dis_od" style="width:100%">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                                <option value="Yes">Yes</option>
                                        ...
                                        <td>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:100%">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="head">OS</th>
                                        <td>
                                            <select name='wat_os' id="wat_os" class="form-control select2 wat_os" style="width:100%">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                                <option value="Yes">Yes</option>
                                        ...
                                        <td>
                                            <select name='reg_os' id="reg_os" class="form-control select2 reg_os" style="width:100%">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                                <option value="Yes">Yes</option>
                                        ...
                                        <td>
                                            <select name='dis_os' id="dis_os" class="form-control select2 dis_os" style="width:100%">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                                <option value="Yes">Yes</option>
                                        ...
                                        <td>
                                            <input type="text" name='syr_os' id="syr_os" class="form-control  syr_os" style="width:100%">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name='sch_od_mm' id="sch_od_mm" class="form-control  sch_od_mm" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='sch_od_min' id="sch_od_min" class="form-control  sch_od_min" style="width:100%">
                                            </td>
                                            <td>
                                ...
                                <!-- <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="head">OD</th>
                                            <td>
                                                <input type="text" name='sch_od_1' id="sch_od_1" class="form-control  sch_od_1" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='sch_od_mm' id="sch_od_mm" class="form-control  sch_od_mm" style="width:100%">
                                            </td>
                                ...
                                <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="head">OD</th>
                                            <td>
                                                <input type="text" name='tea_od' id="tea_od" class="form-control  tea_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='bas_od' id="bas_od" class="form-control  bas_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='imp_od' id="imp_od" class="form-control  imp_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='tear_od' id="tear_od" class="form-control  tear_od" style="width:100%">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="head">OS</th>
                                            <td>
                                                <input type="text" name='tea_os' id="tea_os" class="form-control  tea_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='bas_os' id="bas_os" class="form-control  bas_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='imp_os' id="imp_os" class="form-control  imp_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='tear_os' id="tear_os" class="form-control  tear_od" style="width:100%">
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="head">OD</th>
                                            <td>
                                                <input type="text" name='flou_od' id="flou_od" class="form-control  flou_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='rose_od' id="rose_od" class="form-control  rose_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='lisse_od' id="lisse_od" class="form-control  lisse_od" style="width:100%">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="head">OS</th>
                                            <td>
                                                <input type="text" name='flou_os' id="flou_os" class="form-control  flou_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='rose_os' id="rose_os" class="form-control  rose_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='lisse_os' id="lisse_os" class="form-control  lisse_os" style="width:100%">
                                            </td>
                                        </tr>
                                    </tbody>
                         ...
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table_visions">
                                    <tr>
                                        <td>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%;margin-bottom:15%;">
                                        </td>
                                        <td>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                        <td>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%;margin-top:-10%">
                                            <img src="<?php echo site_url('uploads/popup/54.png') ?>" height="100px"  style="margin-left: -128px;margin-top: 10px;width: 324px;">
                                        </td>
                                        <td>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table_visions">
                                    <tr>
                                        <td>
                                            <label class="lbl_ml">RSR LIO - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%;margin-bottom:15%;">
                                        </td>
                                        <td>
                                            <label class="lbl_ml">RSR LSR - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                        <td>
                                            <label class="lbl_ml">RIO LSR - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="lbl_ml">RMR LMR - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%;margin-bottom: 15%;">
                                        </td>
                                        <td>
                                            <img src="<?php echo site_url('uploads/popup/54.png') ?>" height="100px"  style="margin-left: -128px;margin-top:-34px;width: 324px;">
                                        </td>
                                        <td>
                                            <label class="lbl_ml">RMR LLR - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="lbl_ml">RIR LSO - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%;">
                                        </td>
                                        <td>
                                            <label class="lbl_ml">RIR LIR - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                        <td>
                                            <label class="lbl_ml">RSO LIR - Pos(+) / Neg(-)</label>
                                            <input type="text" name='syr_od' id="syr_od" class="form-control  syr_od" style="width:60%">
                                        </td>
                                    </tr>
                                </table>
                                <div class="col-sm-12">
                                    <textarea  rows="2" class="form-control Ocular_notes" name="Ocular_notes" id="Ocular_notes" placeholder="Write Notes Here..."></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="head">OD</th>
                                            <td>
                                                <input type="text" name='gon_od' id="gon_od" class="form-control  gon_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='siz_od' id="siz_od" class="form-control  siz_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='cup_od' id="cup_od" class="form-control  cup_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='neu_od' id="neu_od" class="form-control  neu_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='hem_od' id="hem_od" class="form-control  hem_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='nfl_od' id="nfl_od" class="form-control  nfl_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='per_od' id="per_od" class="form-control  per_od" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='cr_od' id="cr_od" class="form-control  cr_od" style="width:100%">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="head">OS</th>
                                            <td>
                                                <input type="text" name='gon_os' id="gon_os" class="form-control  gon_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='siz_os' id="siz_os" class="form-control  siz_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='cup_os' id="cup_os" class="form-control  cup_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='neu_os' id="neu_os" class="form-control  neu_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='hem_os' id="hem_os" class="form-control  hem_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='nfl_os' id="nfl_os" class="form-control  nfl_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='per_os' id="per_os" class="form-control  per_os" style="width:100%">
                                            </td>
                                            <td>
                                                <input type="text" name='cr_os' id="cr_os" class="form-control  cr_os" style="width:100%">
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-bordered table_ant_segment">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                            <a href="javascript:void(0);" class="" data-toggle="modal" data-target="#tutorialsplaneModal"><i class="fa fa-plus plus_icons" aria-hidden="true"></i></a>
                                            </td>
                                            <td align="center">
                                            <a href="javascript:void(0);" class="" data-toggle="modal" data-target="#tutorialsplaneModal"><i class="fa fa-plus plus_icons" aria-hidden="true"></i></a>
                                            </td>
        ...
        $(document).on('click', '.editOptometry', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var data = [pgp, vision, dryretinoscopy, cyclo, acceptance, antsegment, nct, at, postsegment, diagnosis];
    ...
    // }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Retinoscopy</div><div style="float:right;padding-right:15px">Print <input type="checkbox" value="1" name="retinoscope_print" id="retinoscope_print" class="opto_print"';
                if(print_data != null && print_data.retinoscope_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><tr><th style="width:20%;">Dry Retinoscopy</th><td>SPH</td><td>Cyl</td><td>Axis</td></tr><tr><th>OD</th><td>' + dryretinoscopy.drs_od_sph + '</td><td>' + dryretinoscopy.drs_od_cyl + '</td><td>' + dryretinoscopy.drs_od_axis + '</td></tr><tr><th>OS</th><td>' + dryretinoscopy.drs_od_sph + '</td><td>' + dryretinoscopy.drs_od_cyl + '</td><td>' + dryretinoscopy.drs_os_axis + '</td></tr></tbody></table></div></div>';
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Cyclo</div><div style="float:right;padding-right:15px">Print <input type="checkbox" value="1" name="cylco_print" id="cylco_print" class="opto_print"';
                if(print_data != null && print_data.cylco_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><tr><th style="width:20%;">Cyclo</th><td>SPH</td><td>Cyl</td><td>Axis</td></tr><tr><th>OD</th><td>' + cyclo.cyclo_od_sph + '</td><td>' + cyclo.cyclo_od_cyl + '</td><td>' + cyclo.cyclo_od_axis + '</td></tr><tr><th>OS</th><td>' + cyclo.cyclo_os_sph + '</td><td>' + cyclo.cyclo_os_cyl + '</td><td>' + cyclo.cyclo_os_axis + '</td></tr></tbody></table></div></div>';
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Acceptance</div><div style="float:right;padding-right:15px">Print <input type="checkbox" name="acceptance_print" value="1" id="acceptance_print" class="opto_print"';
                if(print_data != null && print_data.acceptance_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><tr><th style="width:20%;">Acceptance</th><td>SPH</td><td>Cyl</td><td>Axis</td><td>VA</td><td>ADD</td></tr><tr><th>OD</th><td>' + acceptance.accp_od_sph + '</td><td>' + acceptance.accp_od_cyl + '</td><td>' + acceptance.accp_od_axis + '</td><td>' + acceptance.accp_od_va + '</td><td>' + acceptance.accp_od_add + '</td></tr><tr><th>OS</th><td>' + acceptance.accp_os_sph + '</td><td>' + acceptance.accp_os_cyl + '</td><td>' + acceptance.accp_os_axis + '</td><td>' + acceptance.accp_os_va + '</td><td>' + acceptance.accp_os_add + '</td></tr></tbody></table></div></div>';
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Ant Segments</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="antsegment_print" value="1" id="antsegment_print" class="opto_print"';
                if(print_data != null && print_data.antsegment_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><tr><th style="width:20%;">Ant Segments</th><td>Lids</td><td>Sclera</td><td>Conjuctiva</td><td>Cornea</td><td>A.C</td><td>Pupil</td><td>Lens</td></tr><tr><th>OD</th><td>' + antsegment.as_od_lids + '</td><td>' + antsegment.as_od_sclera + '</td><td>' + antsegment.as_od_conjuctiva + '</td><td>' + antsegment.as_od_cornea + '</td><td>' + antsegment.as_od_ac + '</td><td>' + antsegment.as_od_pupil + '</td><td>' + antsegment.as_od_lens + '</td></tr><tr><th>OS</th><td>' + antsegment.as_os_lids + '</td><td>' + antsegment.as_os_sclera + '</td><td>' + antsegment.as_os_conjuctiva + '</td><td>' + antsegment.as_os_cornea + '</td><td>' + antsegment.as_os_ac + '</td><td>' + antsegment.as_os_pupil + '</td><td>' + antsegment.as_os_lens + '</td></tr></tbody></table></div></div>';
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Tenometry - NCT</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="nct_print" value="1" id="nct_print" class="opto_print"';
                if(print_data != null && print_data.nct_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><th style="width:20%;">NCT in mm/hg</th><td>Before Dilation</td><td>After Dialation</td><td>Time</td></tr><tr><th>OD</th><td>' + nct.nt_od_va_bf + '</td><td>' + nct.nt_od_va_af + '</td><td>' + nct.nt_od_time_bf + '</td></tr><tr><th>OS</th><td>' + nct.nt_os_va_bf + '</td><td>' + nct.nt_os_va_af + '</td><td>' + nct.nt_os_time_bf + '</td></tr></tbody></table></div></div>';

                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Tenometry - ATN</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="at_print" value="1" id="at_print" class="opto_print"';
                ...
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Post Segments</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="postsegment_print" value="1" id="postsegment_print" class="opto_print"';
                if(print_data != null && print_data.postsegment_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><tr><th style="width:20%;">Post Segments</th><td>Fundus</td><td>Cup/DIsc</td><td>Macula</td><td>Vessels</td><td>IOP(mm in Hg)</td></tr><tr><th>OD</th><td>' + postsegment.ps_od_fundus + '</td><td>' + postsegment.ps_od_cupdisc + '</td><td>' + postsegment.ps_od_macula + '</td><td>' + postsegment.ps_od_vessels + '</td><td>' + postsegment.ps_od_iop + '</td></tr><tr><th>OS</th><td>' + postsegment.ps_os_fundus + '</td><td>' + postsegment.ps_os_cupdisc + '</td><td>' + postsegment.ps_os_macula + '</td><td>' + postsegment.ps_os_vessels + '</td><td>' + postsegment.ps_os_iop + '</td></tr></tbody></table></div></div>';
                // html += '<div class="panel panel-default"><div class="panel-heading">Diagnosis</div><div class="panel-body"><table class="table table-bordered"><tbody><tr><th>OD</th><td>'+diagnosis.diagnosis_od+'</td></tr><tr><th>OS</th><td>'+diagnosis.diagnosis_os+'</td></tr></tbody></table></div></div>';
                ...
                if (optometric_comments) {
                    html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px"> Comments</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="optocomments_print" value="1" id="optocomments_print" class="opto_print"';
                    if(print_data != null && print_data.optocomments_print==1){html += 'checked';}
