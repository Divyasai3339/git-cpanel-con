                ...
                <div class="box box-primary"> 
                    <div class="box-header with-border">
                         ...
                         <div class="box-tools pull-right">
                                <a  href="<?php echo base_url() ?>admin/optometry/" class="btn btn-primary btn-sm"><i class="fa fa-reorder"></i> <?php echo " EMR Patients"; ?></a> 
                        </div> 
                    </div><!-- /.box-header -->
                        <div class="box-body">
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/optometry/getcheckoutPatientsDataTable',[],[],100);
