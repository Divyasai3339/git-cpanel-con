...
<div class="modal fade modaled" id="add_optometry" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="modal-dialog  pup-scroll-area" role="document">
      ...
      <div class="modal-content modal-media-content">
          ...
          <form id="form_optometry" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                  ...
                  <div class="modal-body  pb0 ">
                      ...
                      ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3"><b>Gender:</b> <span id="gender"><?php echo $patient_data->gender; ?></span>
                          ...
                          <select name='optometrist_doctor' id="optometrist_doctor" class="form-control select2 optometrist_doctor" <?php

                                        

                              ?> style="width:100%"  >

                                  <option value=""><?php echo 'Select Optometrist' ?></option>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              ...
                              <input type="hidden" name="patient_id" id="patient_id" value="<?php if(isset($patient_id) && !empty($patient_id)){echo $patient_id;}  ?>">
                        ...
                        <div class="col-md-12">
                              ...
                              <table class="table table-bordered table_visions txt_center">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel panel-default"  id="myTabledryr">
                            ...
                            <div class="col-md-3"> 
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-default" id="myTablecyc">
           ...
           <!-- row 2nd end -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-bordered table_acceptance txt_center">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="2">Lens Type & Coating</th>
                                            ...
                                            <tr>
                                                 ...
                                                 <th>
                                                  ...
                                                  <td>
                                                    ...
                                                    <select name='accp_lens' id="accp_lens" class="form-control select2 accp_lens" style="width:100%">
                                    ...
                                    <option value=""><?php echo $this->lang->line('select'); ?>
                                        ...
                                        <option value="K Bifocal">K Bifocal</option>
                                        ...
                                        <option value="Reading Glass">Reading Glass</option>
                                            ...
                                            <select name='accp_coating' id="accp_coating" class="form-control select2 accp_coating" style="width:100%">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading my_class">
                                    ...
                                    <!-- <a id="toggleButton" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading my_class">
                                    ...
                                    <!-- <a id="toggleButtonpac" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->

                                </div>

                                <div class="panel-body" id="myTablepac">
                     ...
                     <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading my_class">
                                Topography
                                    <!-- <a id="toggleButtontopo" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                                </div>
                                <div class="panel-body" id="myTabletopo" >
                                    <table class="table table-bordered table_ant_segment txt_center">
                                        <thead>
                                            <tr>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading my_class">
                                        Schirmers Test
                                            <!-- <a id="toggleButtonsch" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                                    </div>
                                    <div class="panel-body" id="myTablesch" >
                                        <table class="table table-bordered table_ant_segment txt_center">
                                            <thead>
                                                <tr>
                                                    <th>&nbsp</th>
                         ...
                         <div class="col-md-4">
                              <div class="panel panel-default">
                                    <div class="panel-heading my_class">
                                        LCVA
                                        <!-- <a id="toggleButtonlcv" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                                         <div class="pull-right">
                                            <a class="auto_fill" href="javascript:void(0)" onclick="showAutoFillLcva()">Auto Fill</a>
                                        </div>
                                    </div>
                                    <div class="panel-body" id="myTablelcv">
                                        <table class="table table-bordered table_ant_segment txt_center">
                                            <thead>
                                                <tr>
                    ...
                    <div class="row"> 
                            ...
                            <div class="col-md-4">
                                <div class="panel panel-default">
                                    <div class="panel-heading my_class">
                                        Colour Vision Test
                                        <!-- <a id="toggleButtoncol" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                                    </div>
                                    <div class="panel-body" id="myTablecol">
                                        <table class="table table-bordered table_ant_segment txt_center">
                                            <tbody>
                                            <thead>
                                                <tr>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading my_class">
                                        Lacrimal Patency
                                        <!-- <a id="toggleButtonlac" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                                    </div>
                                    <div class="panel-body" id="myTablelac">
                                        <table class="table table-bordered table_visions txt_center">
                                            <tr>
                            ...
                            <!-- Dry Eye Evaluation -->
                                ...
                                <div class="panel-heading my_class">
                                    Dry Eye Evaluation
                                    <!-- <a id="toggleButtondry" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->
                                </div>
                                
                                <div class="panel-body" id="myTabledry">
                    ...
                    <!-- Colour Vision,Lacrimal ,Orbit row --> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-default">
                                ...
                                <!-- <a id="toggleButtonnct" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->

                                </div>

                                <div class="panel-body" id="myTablenct">
                                    ...
                                    <table class="table table-bordered table_acceptance txt_center">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="4" style="background: white;">NCT in mm/hg</th>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-default">
                                ...
                                <!-- <a id="toggleButtonatn" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->

                                </div>

                                <div class="panel-body" id="myTableatn">
                                    ...
                                    <table class="table table-bordered table_acceptance txt_center">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="4" style="background: white;">ATN in mm/hg</th>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading my_class">
                                                    ...
                                                    <span class="fa fa-plus add_master_icons add_investigations" data-type="investigations"></span>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <!-- <select name="as_investigations_od[]" id="as_investigations_od" class="form-control  investigations select2" style="width:100%">
                                                            ...
                                                            <select name="as_investigations_od" id="as_investigations_od" class="form-control select2 " style="width:100%"><option value="">Select</option><?php foreach ($investigations as $dkey => $dvalue) { ?><option value="<?php echo $dvalue->master_value; ?>"><?php echo $dvalue->master_value; ?></option><?php } ?></select>
                                                ...
                                                <div class="col-md-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name='as_inv_type[]' id="" class="form-control select2 " style="width:100%">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-primary addnewinv"><i class="fa fa-plus" aria-hidden="true"></i>Add</button>
                                          ...
                                          <div class="panel panel-default">
                                              ...
                                              <div class="panel-body">
                                                      ...
                                                      <div class="col-md-2" style="margin-bottom: 55px;">
                                                              ...
                                                              <label for=" ">Eye Type</label></br>

                                                              <select name="surgery_eye_type" class="form-control select2" style="width:100%">
                                                          ...
                                                          Surgery Recommendations</label>

                                                          <select name="surgery_recommendations" id="surgery_recommendations" class="form-control select2" style="width:100%">

                                                  <option value=""><?php echo $this->lang->line('select') ?></option>

                                                  <?php foreach($operation_list as $operation_list){ ?>

                                                  <option value="<?php echo $operation_list['operation']; ?>"><?php echo $operation_list['operation']; ?></option>
                     ...
                     <div class="row">
                                       ...
                                       <div class="col-md-3">
                                              ...
                                              <div class="col-sm-12">
                                                  ...
                                                  <textarea  rows="3" class="form-control optometric_comments" name="optometric_comments" id="optometric_comments" placeholder="Comments.."></textarea>
                                      ...
                                      <div class="col-md-4">
                                              ...
                                              <div class="col-sm-12">
                                                  ...
                                                  <textarea  rows="3" class="form-control doctor_notes" name="doctor_notes" id="doctor_notes" placeholder="Doctor Notes....."></textarea>
                                      ...
                                      <div class="col-md-4">
                                              ...
                                              <div class="col-sm-12">
                                                  ...
                                                  <textarea  rows="3" class="form-control optom_notes" name="optom_notes" id="optom_notes" placeholder="Doctor Notes....."></textarea>
                                              ...
                                              <div class="panel panel-default">
                                                  ...
                                                  <div class="panel-body">
                                                      ...
                                                      <table class="table table-bordered table_ant_segment txt_center">
                                                          ...
                                                          <input type="text" style="width:100%" name="as_rvdate" id="rvdate" placeholder=""  class="form-control date rvdate" />
                        ...
                        <!-- Gaze Evaluation, Ocular Motility, Goneoscopy -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading my_class">
                                        ...
                                        <!-- <a id="toggleButtongaz" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->

                                    </div>

                                    <div class="panel-body" id="myTablegaz">
                                        ...
                                        <table class="table table-bordered table_visions">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name='gaz_l1' id="gaz_l1" class="form-control  gaz_l1" style="width:70%;margin-bottom:15%;">

                                                </td>

                                                <td>

                                                    <input type="text" name='gaz_l2' id="gaz_l2" class="form-control  gaz_l2" style="width:15%;margin-left: 125px">

                                                </td>

                                                <td>

                                                    <input type="text" name='gaz_l3' id="gaz_l3" class="form-control  gaz_l3" style="width:70%;float:right;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name='gaz_m1' id="gaz_m1" class="form-control  gaz_m1" style="width:70%;margin-bottom: 15%;">

                                                </td>

                                                <td>

                                                    <input type="text" name='gaz_m2' id="gaz_m2" class="form-control  gaz_m2" style="width:15%;margin-left: 125px">

                                                    <img src="<?php echo site_url('uploads/popup/l.png') ?>" height="60px"  style="margin-left: -190px;margin-top: -50px;width: 130px;">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name='gaz_m3' id="gaz_m3" class="form-control  gaz_m3" style="width:70%;float:right;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name='gaz_r1' id="gaz_r1" class="form-control  gaz_r1" style="width:70%;">

                                                </td>

                                                <td>

                                                    <input type="text" name='gaz_r2' id="gaz_r2" class="form-control  gaz_r2" style="width:15%;margin-left: 125px">

                                                    <img src="<?php echo site_url('uploads/popup/r.png') ?>" height="60px"  style="margin-left: 180px;margin-top: -220px;width: 125px;">

                                                </td>

                                                <td>

                                                    <input type="text" name='gaz_r3' id="gaz_r3" class="form-control  gaz_r3" style="width:70%;float:right;">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading my_class">
                                            ...
                                            <!-- <a id="toggleButtonocu" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->

                                    </div>

                                    <div class="panel-body" id="myTableocu">
                                        ...
                                        <table class="table table-bordered table_visions txt_center">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select name='ocu_1' id="ocu_1" class="ocu_1" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                                ...
                                                <td>
                                                    ...
                                                    <select name='ocu_2' id="ocu_2" class="ocu_2" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                                ...
                                                <td>
                                                    ...
                                                    <br><select name='ocu_3' id="ocu_3" class="ocu_3" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                            ...
                                            <td>
                                                    ...
                                                    <br><select name='ocu_4' id="ocu_4" class="ocu_4" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                                ...
                                                <td>
                                                    ...
                                                    <img src="<?php echo site_url('uploads/popup/13.png') ?>" height="70px"  style="margin-left: 0px;margin-top:-12px;width: 170px;">
                                                ...
                                                <td>
                                                    ...
                                                    <br><select name='ocu_5' id="ocu_5" class="ocu_5" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <br><select name='ocu_6' id="ocu_6" class="ocu_6" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                                ...
                                                <td>
                                                    ...
                                                    <br><select name='ocu_7' id="ocu_7" class="ocu_7" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                                                ...
                                                <td>
                                                    ...
                                                    <br><select name='ocu_8' id="ocu_8" class="ocu_8" style="width:25%;border: 1px solid lightgray;padding: 3px;">
                            ...
                            <!-- Goneoscopy --> 
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <!-- <a id="toggleButtongon" class="btn btn-info btn-sm pull-right" style="padding: 2px 8px 3px 8px">+</a> -->

                                    </div>

                                    <div class="panel-body" id="myTablegon" style="padding-left: 2px;">

                                        <div class="form-group">

                                            <div class="col-sm-6" style="padding-left:1px;">

                                                <div style="width:106%;" class="form-control">
                                                            ...
                                                            <table class="table table-bordered table_dry_retinoscope">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <img src="<?php echo site_url('uploads/popup/14.png') ?>" style="width: 100px;margin: -65px;">
                                             ...
                                             <div class="col-sm-6" style="padding-left: -1px;">
                                                ...
                                                <div style="width:104%;" class="form-control">
                        ...
                        <!-- Gaze Evaluation, Ocular Motility, Goneoscopy end -->
                               ...
                               <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="col-sm-12">
                                        ...
                                        <input type="text" class="datetime" name="ar_time" id="ar_time">
                               ...
                               <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="col-sm-12">
                                        ...
                                        <input type="text" class="datetime" name="optometrist_time" id="optometrist_time">
                               ...
                               <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="col-sm-12">
                                        ...
                                        <input type="text" class="datetime" name="doctor_time" id="doctor_time">
...
<script>
  ...
  $(document).ready(function() {
      ...
      $(document).on('click', '.addnewdiagnosis', function(e) {
          ...
          html += '<div class="col-md-8"><div class="form-group"><label for=" ">Diagnosis</label><div><textarea name="diagnosis_od[]" id="diagnosis_od" class="form-control  diagnosis_od" style="width:100%"></textarea></div></div></div>';
      ...
      $(document).on('click', '.addnewhistory', function(e) {
          ...
          $('.history_container').append(html);
             ...
             $(document).on('click', '.addnewcomplaints', function(e) {
                  ...
                  html += '<div class="col-md-5"><div class="form-group"><label for=" ">Complaints</label><div><select name="complaints[]" id="complaints" class="form-control select2 complaints" style="width:100%"><option value="">Select</option><?php foreach ($complaints_data as $dkey => $dvalue) { ?><option value="<?php echo $dvalue->master_value; ?>"><?php echo $dvalue->master_value; ?></option><?php } ?></select></div></div></div>';

                  

                   html += '<div class="col-md-6"><div class="row"><div class="col-md-4"><div class="form-group"><label for="">Eye</label><select name="complaints_type[]" id="complaints_type" class="form-control  complaints_type" style="width:100%"><option value="-">-</option><option value="od">OD</option><option value="os">OS</option><option value="both">Both</option></select></div></div><div class="col-md-4"><div class="form-group"><label for="">Duration</label><select class="form-control duration" name="complaints_duration[]" id="complaints_duration" style="width:100%"><option value="">select</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8"> 8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option></select></div></div><div class="col-md-4"><div class="form-group"><label for="">Period</label><select name="complaints_period[]" id="period" class="form-control select2 period" style="width:100%"><option value="">Select</option><option value="Day">Day</option><option value="Days">Days</option><option value="Months">Months</option>      <option value="Years">Years</option></select></div></div></div></div>';
          ...
          $(document).on('click', '.addnewinv', function(e) {
                  ...
                  html += `<div class="col-md-6"><div class="form-group"><label for=" ">Investigations</label><div><select name="investigations[]" id="investigations" class="form-control select2 investigations" style="width:100%"><option value="">Select</option><?php foreach ($investigations as $dkey => $dvalue) { ?><option value="<?php echo $dvalue->master_value; ?>"><?php echo $dvalue->master_value; ?></option><?php } ?></select></div></div></div>`;

                  

                   html += `<div class="col-md-6"><div class="row"><div class="col-md-4"><div class="form-group"><label for="">Eye</label><select name="inv_type[]" id="inv_type" class="form-control  inv_type" style="width:100%"><option value="-">-</option><option value="od">OD</option><option value="os">OS</option><option value="both">Both</option><option value="Genearl">Genearl</option></select></div></div>`;
                  ...
                  $('.investigations_container').append(html);
      ...
      $(document).on('click', '.editOptometry', function(e) {
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  var doctor_notes = result.doctor_notes;
                   var optom_notes = result.optom_notes;

                  var orbit = result.orbit;

                  var inv = result.inv;

                  var surgery_recommendations = result.surgery_recommendations;

                  var surgery_eye_type = result.surgery_eye_type;

                  

                   var optometrist_time = result.optometrist_time;

                  var doctor_time = result.doctor_time;

                  var ar_time = result.ar_time;
                ...
                //   var complaints_data = result.complaints_data;
                  ...
                  $('#optometrist_doctor').val(result.staff_id).trigger('change')



                  var role=parseInt("<?php echo getLoginUserRole(); ?>");

                  if(role!='')

                  {

                   if(jQuery.inArray(role,[7,3]) != -1)

                   {

                      var doctor_time=(result.hasOwnProperty('dcot_time') && result.dcot_time!='')?result.dcot_time:'';

                      $('#doctor_time').val(doctor_time);
                   ...
                   if(jQuery.inArray(role,[7,11]) != -1)

                   {

                      var optometrist_time=(result.hasOwnProperty('optometrist_time') && result.optometrist_time!='')?result.optometrist_time:'';

                      $('#optometrist_time').val(optometrist_time);  
                   ...
                   var ar_time=(result.hasOwnProperty('ar_time') && result.ar_time!='')?result.ar_time:'';
...
var max_complaints_duration = 30;

html += '<option value="">Select</option>';

for (let i = 1; i <= max_complaints_duration; i++) {

    if (value.complaints_duration == i) {
        ...
        html += '<option value="'+i+'">'+i+'</option>';
                        ...
                        if (value.complaints_period == "Day") {

                            html += '<option selected value="Day">Day</option>';
...
html += '<option value="20">20</option>';
              ...
              html += '<div class="col-md-2"><div class="form-group"><label for=" ">Eye Type</label><div><select name="diagnosis_od_os[]" id="diagnosis_od_os" class="form-control select2 diagnosis_od_os" style="width:100%">';
                  ...
                  $('.optometric_comments').empty().val(optometric_comments);
                   ...
                   $('.doctor_notes').empty().val(doctor_notes);
                    $('.optom_notes').empty().val(optom_notes);

                  $('.surgery_recommendations').empty().val(surgery_recommendations);

                  $('.surgery_eye_type').empty().val(surgery_eye_type);
...
loadMasterData('investigations', 'investigations');
            ...
            success: function(data) {
                ...
                if (data.flag == 1) {
                    ...
                    $.each(data.data, function(key, val) {
                      ...
                      html += '<option value="' + val.master_value + '">' + val.master_value + '</option>';
  ...
  function load(opdid) {
      ...
      $.ajax({
          ...
          success: function(data) {
              ...
              var optometrist_doctor = result.optometrist_doctor;
              ...
              var html = "";
                ...
                var staff_name=(result.hasOwnProperty('staff') && !jQuery.isEmptyObject(result.staff))?result.staff.name:'';
...
html += '<div class="col-md-3">Patient Name : '+ patient_data.patient_name+' </div><div class="col-md-2">Age : '+ patient_data.age+' </div><div class="col-md-2">Gender : '+ patient_data.gender+' </div><div class="col-md-3">Optometrist : '+ staff_name+' </div></div><div  class="col-md-2"><div style="float:right"><button class="btn btn-primary editOptometry" data-id="' + result.id + '">Edit</button> &nbsp;<button class="btn btn-primary print_emr" data-id="' + result.id + '" data-visitid="' + visitid + '">Print</button></div></div><br><br>';
              ...
              html +='<div class="row"><div class="col-md-3"><div class="col-sm-12" class="bg-primary padding" ><div class="padding"><table class="table table-bordered success "><thead><tr class="info text-center cntr"><th class="text-center ">';

              if(print_data != null && print_data.vision_print==1){html += 'checked';}

              html +='<div style="float:right;padding-right:0px"> <i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" checked name="complaints_print" value="1" id="complaints_print" class="opto_print"/></div>';

              html +='<div style="text-align:left;">Chief Complaints</div></th></tr></thead><tbody>';

               $.each(complaints_data, function(key, val) {

               html += '<tr><td>' + val.complaints + " " + val.complaints_type + " " + val.complaints_duration +" "+ val.complaints_period +'</td></tr>';
              ...
              html +='</tbody></table><br><table style="display:none;" class="table table-bordered mb-1"><thead><tr class="info"><th class="text-start ">';

              if(print_data != null && print_data.inv_print==1){html += 'checked';}

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" checked  name="inv_print" value="1" id="inv_print" class="opto_print"/></div>'; 

              html +='<div style="text-align:left;display:none;">History Of Present Illness</div></th></tr></thead><tbody><tr><td>'+ inv +  '</td></tr>';

               

               

              html +='</tbody></table><br><table class="table table-bordered"><thead><tr class="info"><th colspan="2" class="text-start ">';

              if(print_data != null && print_data.history_print==1){html += 'checked';} 

              html+='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" name="history_print" value="1" id="history_print" class="opto_print"/></div>'; 

              html+='<div style="text-align:left;">History Of Past Illness</div></th></tr></thead><thead>'; 

                $.each(history_data, function(key, val) { 

                  html += '<tr><td>' + val.disease + " "+ val.duration + " "+val.period+ '</td></tr>';
             ...
             html +='</tbody></table></div></div></div><!-comment -> <div class="col-md-9"><!--<div class="col-md-9"></div>--> <div class="col-sm-4"><div class="padding"><table class="table table-bordered"><thead><tr class="info"><th colspan="5" class="text-center cntr">';

             if(print_data != null && print_data.vision_print==1){html += 'checked';}

             html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" checked value="1" name="vision_print" id="vision_print" class="opto_print"/></div>'; 

             html+='<div style="text-align:left;">Visual Acuity</div> </th></tr></thead><thead><tr><th>#</th><th colspan="2">OD</th><th colspan="2">OS</th></tr></thead><tbody><tr><td>Unaided</td><td>' + vision.vision_od_presenting + '</td><td>'+ vision.vision_od_near_presenting +'</td><td>'+ vision.vision_os_presenting +'</td><td>'+ vision.vision_os_near_presenting +'</td></tr><tr><td>Pinhole</td><td colspan="2">2</td> <!--<td>2</td>--><td colspan="2">3</td> <!--<td>3</td>--></tr></tbody></table></div></div>';

             



             // checkbox id not mentioned this fields

             html +='<div class="col-sm-4"><div class="padding"><table class="table table-bordered"><thead><tr><th class="info text-center cntr" colspan="4">';

             if(print_data != null && print_data.vision_print==1){html += 'checked';}

             html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" checked value="1" name="vision_print" id="vision_print" class="opto_print"/></div>'; 

             html +='<div style="text-align:left;">Retinoscopy</div></th></tr><tr><th>Retinoscopy</th><th>SPH</th><th>Cyl</th><th>Axis</th></tr></thead><tbody><tr><th>OD</th><td>'+ dryretinoscopy.drs_od_sph +'</td><td>'+ dryretinoscopy.drs_od_cyl +'</td><td>'+ dryretinoscopy.drs_od_axis +'</td></tr><tr><th>OS</th><td>'+ dryretinoscopy.drs_os_sph +'</td><td>'+ dryretinoscopy.drs_os_cyl +'</td><td>'+ dryretinoscopy.drs_os_axis +'</td></tr></tbody></table></div></div>';
             ...
             html +='<div style="text-align:left;">Cyclo</div></th></tr><tr><th>Cyclo</th><th>SPH</th><th>Cyl</th><th>Axis</th></tr></thead><tbody><tr><th>OD</th><td>'+ cyclo.cyclo_od_sph +'</td><td>'+ cyclo.cyclo_od_cyl +'</td><td>'+ cyclo.cyclo_od_axis +'</td></tr><tr><th>OS</th><td>'+ cyclo.cyclo_os_sph +'</td><td>'+ cyclo.cyclo_os_cyl +'</td><td>'+ cyclo.cyclo_os_axis +'</td></tr></tbody></table></div></div>';

              //    



                        html +='<div class="col-sm-12"><div class="col-sm-5" style="padding-top:10px;  padding-left:0px;"><div class="padding"><table class="table table-bordered"><thead><tr class="info"><th colspan="7" class="text-center cntr">';

             if(print_data != null && print_data.vision_print==1){html += 'checked';}

             html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" name="pgp_print" value="1" id="pgp_print" class="opto_print"/></div>';

             html +='<div style="text-align:left;">PGP</div></th></tr></thead><thead><tr><th>PGP</th><th>SPH</th><th>Cyl</th><th>Axis</th><th>ADD</th><th>BCVA</th><th>BCNVA</th></tr></thead><tbody><tr><th>OD</th><td>'+ pgp.pgp_od_sph +'</td><td>'+ pgp.pgp_od_cyl +'</td><td>'+ pgp.pgp_od_axis +'</td><td>'+ pgp.pgp_od_add +'</td><td>'+ pgp.pgp_od_eom +'</td><td>'+ pgp.pgp_od_tropia +'</td></tr><tr><th>OS</th><td>'+ pgp.pgp_os_sph +'</td><td>'+ pgp.pgp_os_cyl +'</td><td>' + pgp.pgp_os_axis + '</td><td>'+ pgp.pgp_os_add +'</td><td>'+ pgp.pgp_os_eom +'</td><td>'+ pgp.pgp_os_tropia +'</td></tr></tbody></table></div></div>';

            

             html +='<div class="col-sm-5" style="padding-top:10px;  padding-right:0px;"><div class="padding"><table class="table table-bordered"><thead><tr class="info"><th colspan="7" class="text-center cntr">';

             html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" name="pgp_print" value="1" id="pgp_print" class="opto_print"/></div>';

              if(print_data != null && print_data.pgp_print==1){html += 'checked';}

             html +='<div style="text-align:left;">Acceptance</div></th></tr></thead><thead><tr><th>Acceptance</th><th>SPH</th><th>Cyl</th><th>Axis</th><th>ADD</th><th>BCVA</th><th>BCNVA</th></tr></thead><tbody><tr><th>OD</th><td>'+ acceptance.accp_od_sph +'</td><td>'+ acceptance.accp_od_cyl +'</td><td>'+ acceptance.accp_od_axis +'</td><td>'+ acceptance.accp_od_add +'</td><td>'+ acceptance.accp_od_va +'</td><td>'+ acceptance.accp_od_bcnva +'</td></tr><tr><th>OS</th><td>'+ acceptance.accp_os_sph +'</td><td>'+ acceptance.accp_os_cyl +'</td><td>'+ acceptance.accp_os_axis +'</td><td>'+ acceptance.accp_os_add +'</td><td>'+ acceptance.accp_os_va +'</td><td>'+ acceptance.accp_os_bcnva +'</td></tr></tbody></table></div></div>';

             html +='<div class="col-sm-2" style="padding-top:10px;  padding-right:0px;"><div class="padding"><table class="table table-bordered"><thead><tr class="info"><th colspan="7" class="text-center cntr">';
            
              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" name="pgp_print" value="1" id="pgp_print" class="opto_print"/></div>';

              if(print_data != null && print_data.pgp_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Lens</div></th></tr></thead><thead><tr><th>Lens</th><th>Lens Type</th><th>Lens Coating</th></tr></thead><tbody><tr><th></th><td>'+ acceptance.accp_lens +'</td><td>'+ acceptance.accp_coating +'</td></tr></tbody></table>';
             ...
             html +='</div></div></div></div></div></div></div>'; 
              ...
              html +='<div class="row"><div class="col-md-6"><div class="col-sm-6"><table class="table table-bordered"><thead><tr class="info"><th colspan="3" class="text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" checked  name="antsegment_print" value="1" id="antsegment_print" class="opto_print"/></div>';

              if(print_data != null && print_data.antsegment_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Ant&nbsp;Segments</div></th></tr></thead><thead><tr><th>Ant&nbsp;Segments</th><th>OD</th><th>OS</th></tr></thead><tbody><tr><th>Lids</th><td>'+ antsegment.as_od_lids+'</td><td>'+ antsegment.as_os_lids+'</td></tr><tr><th>Conjuctive</th><td>'+ antsegment.as_od_conjuctiva +'</td><td>'+ antsegment.as_os_conjuctiva +'</td></tr><tr><th>Sclera</th><td>'+ antsegment.as_od_sclera +'</td><td>'+ antsegment.as_os_sclera +'</td></tr><tr><th>Cornea</th><td>'+ antsegment.as_od_cornea +'</td><td>'+ antsegment.as_os_cornea +'</td></tr><tr><th>A.C</th><td>'+ antsegment.as_od_ac +'</td><td>'+ antsegment.as_os_ac +'</td></tr><tr><th>Iris</th><td>'+antsegment.as_od_iris +'</td><td>'+antsegment.as_os_iris +'</td></tr><tr><th>Pupil</th><td>'+ antsegment.as_od_pupil +'</td><td>'+ antsegment.as_os_pupil +'</td></tr><tr><th>Lens</th><td>'+ antsegment.as_od_lens +'</td><td>'+ antsegment.as_os_lens +'</td></tr></tbody></table></div>';



              html +='<div class="col-sm-6"><table class="table table-bordered"><thead><tr class="info"><th colspan="3" class="text-center cntr">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" checked  name="postsegment_print" value="1" id="postsegment_print" class="opto_print"/></div>';

              if(print_data != null && print_data.postsegment_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Post&nbsp;Segments</div></th></tr></thead><thead><tr><th>Post&nbsp;Segments</th><th>OD</th><th>OS</th></tr></thead><tbody><tr><th>Vitreous</th><td>'+postsegment.ps_od_fundus +'</td><td>'+postsegment.ps_os_fundus +'</td></tr><tr><th>Cup/DIsc</th><td>'+ postsegment.ps_od_cupdisc +'</td><td>'+ postsegment.ps_od_cupdisc +'</td></tr><tr><th>CDR</th><td>'+ postsegment.as_od_cdr +'</td><td>'+ postsegment.as_os_cdr +'</td></tr><tr><th>NFLD</th><td>'+postsegment.as_od_nfld +'</td><td>'+postsegment.as_od_nfld +'</td></tr><tr><th>PPA</th><td>'+postsegment.as_od_ppa +'</td><td>'+postsegment.as_os_ppa +'</td></tr><tr><th>Macula</th><td>'+ postsegment.ps_od_macula +'</td><td>'+ postsegment.ps_os_macula +'</td></tr><tr><th>Vessels</th><td>'+ postsegment.ps_od_vessels +'</td><td>'+ postsegment.ps_os_vessels +'</td></tr><tr><th>Periphery</th><td>'+postsegment.ps_od_iop +'</td><td>'+postsegment.ps_os_iop +'</td></tr></tbody></table></div></div>';                



              html +='<div class="col-md-6"><div class="col-sm-12"><table class="table table-bordered"><thead><tr class="info"><th colspan="5" class="text-center cntr">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="ker_print" value="1" id="ker_print" class="opto_print"/></div>';

              if(print_data != null && print_data.ker_print==1){html += 'checked';} 

              html +='<div style="text-align:left;">Keratometry</div></th></tr></thead><thead><tr><th>Keratometry</th><th>H Axis</th><th>V Axis</th><th>AVG K Val</th><th>CYL Val</th></tr></thead><tbody><tr><th>OD</th><td>'+ ker.ker_od_ha1 + " @ " + ker.ker_od_ha2 + '</td><td> '+ ker.ker_od_va1 + " @ " + ker.ker_od_va2 +' </td><td> ' + ker.ker_od_av + '</td><td>'+ ker.ker_od_cy +'</td></tr><tr><th>OS</th><td>'+ ker.ker_os_ha1 + " @ " + ker.ker_os_ha2 +'</td><td>'+ ker.ker_os_va1 + " @ " + ker.ker_os_va2 +'</td><td>'+ ker.ker_os_av +'</td><td>'+ ker.ker_os_cy +'</td></tr><br></tbody></table></div>';



              html +='<div class="col-sm-12"><table class="table table-bordered"><thead><tr class="info"><th colspan="10" class="text-center cntr">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" name="pac_print" value="1" id="pac_print" class="opto_print"/></div>';

              if(print_data != null && print_data.pac_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Pachymetry</div></th></tr></thead><thead><tr><th>Pachymetry</th><th>Pachymetry</th><th>KVf</th><th>KVb</th><th>Class</th><th>HV ID</th><th>ACD</th><th>ANGLE</th><th>Pupil Diameter</th></tr></thead><tbody><tr><th>OD</th><td>'+ pac.pac_od_pac +'</td><td>'+ pac.pac_od_kvf +'</td><td>'+ pac.pac_od_kvb +'</td><td>'+ pac.pac_od_cla +'</td><td>'+ pac.pac_od_hv +'</td><td>'+ pac.pac_od_acd +'</td><td>'+ pac.pac_od_ang +'</td><td>'+ pac.pac_od_pup +'</td></tr><tr><th>OS</th><td>' + pac.pac_os_pac + '</td><td>'+ pac.pac_os_kvf +'</td><td>'+ pac.pac_os_kvb +'</td><td>'+ pac.pac_os_cla +'</td><td>'+ pac.pac_os_hv +'</td><td>'+ pac.pac_os_acd +'</td><td>'+ pac.pac_os_ang +'</td><td>'+ pac.pac_os_ang +'</td></tr><br></tbody></table></div></div></div>'; 

                //    row 3 

              html +='<div class="row" style="padding-top:5px;"><div class="col-md-12"><div class="col-sm-3"><table class="table table-bordered"><thead><tr class="info"><th colspan="4" class="text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="nct_print" value="1" id="nct_print" class="opto_print"/></div>';

              if(print_data != null && print_data.nct_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Tenometry - NCT</div></th></tr></thead><thead><tr><th>NCT in mm/hg</th><th>Before Dilation</th><th>After Dilation</th><th>Time</th></tr></thead><tbody><tr><th>OD</th><td>'+ nct.nt_od_va_bf +'</td><td>'+ nct.nt_od_va_af +'</td><td>'+ nct.nt_od_time_bf +'</td></tr><tr><th>OS</th><td>'+ nct.nt_os_va_bf +'</td><td>'+ nct.nt_os_va_af+'</td><td>'+ nct.nt_os_time_bf +'</td></tr></tbody></table></div>';

              html +='<div class="col-sm-3"><table class="table table-bordered"><thead><tr class="info"><th colspan="4" class="text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="at_print" value="1" id="at_print" class="opto_print"/></div>';

              if(print_data != null && print_data.at_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Tenometry - ATN</div></th></tr></thead><thead><tr><th>ATN in mm/hg</th><th>Before Dilation</th><th>After Dilation</th><th>Time</th></tr></thead><tbody><tr><th>OD</th><td>'+ at.at_od_va_bf +'</td><td>'+ at.at_od_va_af +'</td><td>'+ at.at_od_time_bf +'</td></tr><tr><th>OS</th><td>'+ at.at_os_va_bf +'</td><td>'+ at.at_os_va_af +'</td><td>'+ at.at_os_time_bf +'</td></tr></tbody></table></div>';

              html+='<div class="col-sm-2"><table class="table table-bordered"><thead><tr class="info"><th colspan="4" class="text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="top_print" value="1" id="top_print" class="opto_print"/></div>';

              if(print_data != null && print_data.top_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Topograpy</div></th></tr></thead><thead><tr><th>Topograpy</th><th>OD</th><th>OS</th></tr></thead><tbody><tr><th>Slim K</th><td>'+ top.top_sli_od +'</td><td>'+ top.top_min_od +'</td></tr><tr><th>Min K</th><td>'+ top.top_sli_os +'</td><td>'+ top.top_min_os +'</td></tr></tbody></table></div>';

              html +='<div class="col-sm-2"><table class="table table-bordered"><thead><tr class="info"><th colspan="4" class="text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="sch_print" value="1" id="sch_print" class="opto_print"/></div>';

              if(print_data != null && print_data.sch_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Schirmers Test</div></th></tr></thead><thead><tr><th>Schirmers</th><th>mm in 5</th><th>mm in 5</th></tr></thead><tbody><tr><th>OD</th><td>'+ sch.sch_od_mmf +'</td><td>'+ sch.sch_od_mms +'</td></tr><tr><th>OS</th><td>'+ sch.sch_os_mmf +'</td><td>'+ sch.sch_os_mms +'</td></tr></tbody></table></div>';

              html +='<div class="col-sm-2"><table class="table table-bordered"><thead><tr class="info"><th colspan="4" class="text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="lcva_print" value="1" id="lcva_print" class="opto_print"/></div>';

              if(print_data != null && print_data.lcva_print==1){html += 'checked';}

              html +='<div style="text-align:left;">LCVA</div></th></tr></thead><thead><tr><th>Lcva</th><th>SPH</th><th>CYL</th><th>Axis</th></tr></thead><tbody><tr><th>OD</th><td>'+ lcva.lcva_od_sph +'</td><td>'+ lcva.lcva_od_cyl +'</td><td>'+ lcva.lcva_od_axis +'</td></tr><tr><th>OS</th><td>'+ lcva.lcva_os_sph +'</td><td>'+ lcva.lcva_os_cyl +'</td><td>'+ lcva.lcva_os_axis +'</td></tr></tbody></table></div></div></div>'; 
              ...
              html +='<div class="row"><div class="col-sm-4"><table class="table table-bordered" style="margin-bottom: 0px !important;"><thead><tr><th colspan="3" class="info text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="cvt_print" value="1" id="cvt_print" class="opto_print"/></div>';

              if(print_data != null && print_data.cvt_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Colour Vision Test</div></th></tr></thead><tbody><tr><th>OD</th><td colspan="2">'+ cvt.cvt_od +'</td></tr><tr><th>OS</th><td colspan="2">'+ cvt.cvt_os +'</td></tr></tbody></table><div class="col-sm-12" style="padding-top: 31px;"><table class="table table-bordered" style="margin-bottom: 0px !important;"  class="padding"><thead><tr><th colspan="3" class="info text-center">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="investigations_print" value="1" id="investigations_print" class="opto_print"/></div>';

              if(print_data != null && print_data.investigations_print==1){html += 'checked';}

             html +=' Investigation</th></tr></thead><tbody>';

             

            //  $.each(antsegment, function(key, val) {

            //         html += '<tr><td>' + val.as_inv_type + '</td><td>' + val.as_investigations_od +'</td></tr>';

            //     })

              

             html +='<tr><td>' + antsegment.as_inv_type + '</td><td style="text-transform:uppercase;">' + antsegment.as_investigations_od + '</td></tr></tbody></table></div></div>';   

              

                                                                                            

               html +='<div class="col-sm-4"><div class="padding"><table class="table table-bordered"><thead><tr><th class="info text-center cntr" colspan="5">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox" name="lac_print" value="1" id="lac_print" class="opto_print"/></div>';

              if(print_data != null && print_data.lac_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Lacrimal Patency</div></th></tr><tr><th>Lacrimal Patency</th><th>Watering</th><th>Regurgitation</th><th>Discharge</th><th>Syringing</th></tr></thead><tbody><tr><th>OD</th><td>'+ lac.lac_od_wat +'</td><td>'+ lac.lac_od_reg +'</td><td>'+ lac.lac_od_dis +'</td><td>'+ lac.lac_od_syr +'</td></tr><tr><th>OS</th><td>'+ lac.lac_os_wat +'</td><td>'+lac.lac_os_reg +'</td><td>'+ lac.lac_os_dis +'</td><td>'+ lac.lac_os_syr +'</td></tr></tbody></table></div><div class="col-sm-12" style="padding-top: 7px;"><table class="table table-bordered" style="margin-bottom: 0px !important;"  class="padding"><thead><tr><th colspan="3" class="info" >Surgery recommendations <i class="fa fa-print" style="font-size:13px;padding-left: 123px;"></i><input type="checkbox"  name="antsegment_print" style="float:right;" value="1" id="surgery_recommendations_print" class="opto_print"';

              if(print_data != null && print_data.surgery_recommendations_print==1){html += 'checked';}

              

              html += ' /> </th></tr></thead><tbody><tr><td>' + surgery_eye_type + ' </td><td colspan="2">' + surgery_recommendations + '</td></tr></tbody></table></div></div>';
             ...
             html+='<div class="col-sm-4"><div class="padding"><table class="table table-bordered"><thead><tr><th class="info text-center cntr" colspan="6">';

              html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i><input type="checkbox"  name="eye_print" value="1" id="eye_print" class="opto_print"/></div>';

              if(print_data != null && print_data.eye_print==1){html += 'checked';}

              html +='<div style="text-align:left;">Dry Eye Evaluation</div></th></tr><tr><th>Eye</th><th>Tear Meniscus Height</th><th>Basic Secretion Test</th><th>Impression Cytology</th><th>Tear Breakup Time</th></tr></thead><tbody><tr><th>OD</th><td>'+ eye.eye_tea_od +'</td><td>'+ eye.eye_bas_od +'</td><td>'+ eye.eye_imp_od +'</td><td>'+ eye.eye_tear_od +'</td></tr><tr><th>OS</th><td>'+ eye.eye_tea_os +'</td><td>'+ eye.eye_bas_os +'</td><td>'+ eye.eye_imp_os +'</td><td>'+ eye.eye_tea_os +'</td></tr></tbody></table>&nbsp;<table class="table table-bordered" style="margin-top: -24px;"><thead><tr><th>Staining</th><th>Flourescein</th><th>Rose Bengal</th><th>Lissemine Green</th></tr></thead><tbody><tr><th>OD</th><td>'+ sta.sta_flo_od +'</td><td>'+ sta.sta_ros_od +'</td><td>'+ sta.sta_lis_od +'</td></tr><tr><th>OS</th><td>'+ sta.sta_flo_os +'</td><td>'+ sta.sta_ros_os +'</td><td>'+ sta.sta_lis_os +'</td></tr></tbody></table></div></div></div>';
...
html+='<div class="col-sm-3"><div class="padding"><table class="table table-bordered success "><thead><tr class="info"><th class="text-center">';

html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="orbit_print" value="1" id="orbit_print" class="opto_print"/></div>';

   if(print_data != null && print_data.orbit_print==1){html += 'checked';}



html +='<div style="text-align:left;">Orbit and Adnexa</div></th></tr></thead><tbody><tr><td>'+ orbit +'</td></tr></tbody></table></div></div>';


html+='<div class="col-sm-2"><div class="padding"><table class="table table-bordered success "><thead><tr class="info"><th class="text-center">';

  html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="optocomments_print" value="1" id="optocomments_print" class="opto_print"/></div>';

      if(print_data != null && print_data.optocomments_print==1){html += 'checked';}

 

  html +='<div style="text-align:left;">Plan of Care</div></th></tr></thead><tbody><tr><td>'+ optometric_comments+'</td></tr></tbody></table></div></div>';

  

 html+='<div class="col-sm-3"><div class="padding"><table class="table table-bordered success "><thead><tr class="info"><th class="text-center">';

  html +='<div style="float:right;padding-right:0px"></div>';

      if(print_data != null && print_data.optocomments_print==1){html += 'checked';}

 

  html +='<div style="text-align:left;">Doctor Notes</div></th></tr></thead><tbody><tr><td>'+ doctor_notes+'</td></tr></tbody></table></div></div>';
...
html+='<div class="col-sm-3"><div class="padding"><table class="table table-bordered success "><thead><tr class="info"><th class="text-center">';
  ...
  html +='<div style="text-align:left;">Optom Notes</div></th></tr></thead><tbody><tr><td>'+ optom_notes+'</td></tr></tbody></table></div></div>';

html+='<div class="col-sm-1"><div class="padding"><table class="table table-bordered success "><thead><tr class="info"><th class="text-center">';

html +='<div style="float:right;padding-right:0px"><i class="fa fa-print" style="font-size:13px;"></i> <input type="checkbox"  name="rvdate_print" value="1" id="rvdate_print" class="opto_print"/></div>';

    if(print_data != null && print_data.rvdate_print==1){html += 'checked';}



html +='<div style="text-align:left;">Review Date</div></th></tr></thead><tbody><tr><td>'+ antsegment.as_rvdate +'</td></tr></tbody></table></div></div>';
...
html+= '</div>';
             ...
             html += '<div class="row"><div class="col-md-12"><div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Gaze Evaluation</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="gaz_print" value="1" id="gaz_print" class="opto_print"';
                if(print_data != null && print_data.gaz_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><tr><input style="margin-right: 190px;width:30px;margin-top: 25px;" readonly value=' + gaz.gaz_l1 + '><input style="margin-right: 140px;width:30px;margin-right: 100px;" readonly value=' + gaz.gaz_l2 + '><input style="margin-top: 25px;width:30px; float:right" readonly value=' + gaz.gaz_l3 + '><input style="margin-right: 190px;margin-bottom: 0px;margin-top:35px; width:30px;" readonly value=' + gaz.gaz_m1 + '><input style="margin-right: 0px; width:30px;" readonly value=' + gaz.gaz_m2 + '><img src="<?php echo site_url('uploads/popup/l.png') ?>" height="50px"  style="margin-left: 80px;margin-top: -50px;width: 120px;"><img src="<?php echo site_url('uploads/popup/r.png') ?>" height="50px"  style="margin-left: 270px;margin-top: -85px;width: 120px;"><input style="float:right;margin-top: -43px;width:30px;" readonly value=' + gaz.gaz_m3 + '><input style="margin-right: 190px; width:30px;margin-top: 10px;" readonly value=' + gaz.gaz_r1 + '><input style="margin-right: 0px;width:30px;" readonly value=' + gaz.gaz_r2 + '><input style="float: right;width:30px; margin-top: 10px;" readonly value=' + gaz.gaz_r3 + '></tr></tbody></table></div></div></div>';



                html += '<div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Ocular Motility</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="ocu_print" value="1" id="ocu_print" class="opto_print"';

               if(print_data != null && print_data.ocu_print==1){html += 'checked';}

                html += ' /></div><br></div><div class="panel-body"><table class="table"><tbody><tr><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RSR LIO</th><th align="center" style="border-top: 0px solid #f4f4f4;padding-left:40;text-align: center !important;">RSR LSR</th><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RIO LSR</th></tr><tr><td style="border-top: 0px solid #f4f4f4;text-align: center !important;"><input style="width:60%;margin-left:-69px;" readonly value=' + ocu.ocu_1 + ''+ ocu.ocu_r1 +'></td><td style="border-top: 0px solid #f4f4f4;text-align: center !important;"><input style="width:60%" readonly value=' + ocu.ocu_2 + ''+ ocu.ocu_r2 +'></td><td style="border-top: 0px solid #f4f4f4;"><input readonly style="width:60%" value=' + ocu.ocu_3 + ''+ ocu.ocu_r3 +'></td></tr><tr><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RLR LMR</th><th style="border-top: 0px solid #f4f4f4;text-align: center !important;"></th><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RMR LLR</th></tr><tr><td style="border-top: 0px solid #f4f4f4;"><input readonly style="width:60%" value=' + ocu.ocu_4 + ''+ ocu.ocu_r4 +'></td><td style="border-top: 0px solid #f4f4f4;"><img src="<?php echo site_url('uploads/popup/13.png') ?>" height="90px" style="margin: -55px;"></td><td style="border-top: 0px solid #f4f4f4;"><input style="width:60%" readonly value=' + ocu.ocu_5 + ''+ ocu.ocu_r5 +'></td></tr><tr><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RIR LSO</th><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RIR LIR</th><th style="border-top: 0px solid #f4f4f4;text-align: center !important;">RSO LIR</th></tr><tr><td style="border-top: 0px solid #f4f4f4;"><input style="width:60%" readonly value=' + ocu.ocu_6 + ''+ ocu.ocu_r6 +'></td><td style="border-top: 0px solid #f4f4f4;"><input style="width:60%" readonly value=' + ocu.ocu_7 + ''+ ocu.ocu_r7 +'></td><td style="border-top: 0px solid #f4f4f4;"><input style="width:60%" readonly value=' + ocu.ocu_8 + ''+ ocu.ocu_r8 +'></td></tr></tbody></table></div></div></div>'; 
                ...
                html += '<div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Gonioscopy</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="gon_print" value="1" id="gon_print" class="opto_print"';

                if(print_data != null && print_data.gon_print==1){html += 'checked';}

                html += ' /></div><br></div><div class="panel-body" style="width:50%;"><table class="table table-bordered"><tbody><th style="width:20%;" colspan="3">OD</th></tr><tr><td style="border-right: 1px solid #e5f3f3  !important;"><input class="form-control text-center" style="width:25%;margin-left: 80px;margin-bottom: 25px;" readonly value=' + gon.gon_od_1 + ' ><tr></tr></td><td style="border-right: 1px solid #e5f3f3  !important;border-top: 1px solid #e5f3f3  !important;border-bottom: 1px solid #e5f3f3 !important;"><input class="form-control text-center" style="width:25%;float: left;" readonly value=' + gon.gon_od_2 + '></td><td style="border: 0px solid grey !important"><img src="<?php echo site_url('uploads/popup/14.png') ?>" class="img_cl" style="width: 95px;margin: -205px;"></td><td style="border-top: 1px solid #e5f3f3  !important;border-bottom: 1px solid #e5f3f3 !important;border-left: 0px solid !important;"><input readonly class="form-control text-center" style="width:75%;float: right;"  value=' + gon.gon_od_3 + '></td></tr><tr><td style="border-right: 1px solid #e5f3f3  !important;border-top: 1px solid #e5f3f3  !important;"><input class="form-control text-center" style="width:25%;margin-left: 80px;margin-top: 20px;" readonly value=' + gon.gon_od_4 + '><tr></tr></td></tbody></table></div><div class="panel-body" style="width:50%;margin-left: 298px;margin-top: -244px;"><table class="table table-bordered"><tbody><th style="width:20%;" colspan="3">OS</th></tr><tr><td style="border-right: 1px solid #e5f3f3  !important;"><input class="form-control text-center" style="width:25%;margin-left: 80px;margin-bottom: 25px;" readonly value=' + gon.gon_os_1 + '><tr></tr></td><td style="border-right: 1px solid #e5f3f3  !important;border-top: 1px solid #e5f3f3  !important;border-bottom: 1px solid #e5f3f3 !important;"><input class="form-control text-center" style="width:25%;float: left;" readonly value=' + gon.gon_os_2 + '></td><td style="border: 0px solid grey !important"><img src="<?php echo site_url('uploads/popup/14.png') ?>" class="img_cl" style="width: 95px;margin: -205px;"></td><td style="border-top: 1px solid #e5f3f3  !important;border-bottom: 1px solid #e5f3f3 !important;border-left: 0px solid !important;"><input class="form-control text-center" style="width:75%;float: right;" readonly value=' + gon.gon_os_3 + '></td></tr><tr><td style="border-right: 1px solid #e5f3f3  !important;border-top: 1px solid #e5f3f3  !important;"><input class="form-control text-center" style="width:25%;margin-left: 80px;margin-top: 20px;" readonly value=' + gon.gon_os_4 + '><tr></tr></td></tbody></table></div></div></div></div></div>';

             

              html+=`<div class="panel panel-default"style="margin-bottom: 0px;"><div class="panel-heading"><div style="float:left;padding-left:15px">Staff Time Entry</div><div style="float:right;padding-right:0px">Print <input type="checkbox" checked name="stafftime_print" value="1" id="stafftime_print" class="opto_print"/></div><br></div><div class="panel-body">`;
...
function SetPatientDetail(patient_id){
     ...
     $.ajax({
            ...
            success: function(res) {
                ...
                $('#patient_image').attr('src',base_url+res.image)

                $('.privew_img').attr('href',base_url+res.image);
...
$(document).ready(function() {
     ...
     $('#formAddMasterData').on('submit', (function(e) {
      ...
      $(document).on('click', '.add_investigations', function(e) {
...
$(document).ready(function() {
 ...
 $("#toggleButtontopo").click(function() {
...
$("#toggleButtonsch").click(function() {
...
$("#toggleButtonpac").click(function() {
...
$("#toggleButtonatn").click(function() {
...
$("#toggleButtonnct").click(function() {
...
$("#toggleButtoncol").click(function() {
...
$("#toggleButtonlcv").click(function() {
...
$("#toggleButtonorb").click(function() {
...
$("#toggleButtonlac").click(function() {
...
$("#toggleButtondry").click(function() {
...
$("#toggleButtongaz").click(function() {
...
$("#toggleButtonocu").click(function() {
...
$("#toggleButtongon").click(function() {
...
$("#toggleButtonvis").click(function() {
