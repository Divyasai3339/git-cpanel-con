            ...
            <form id="form_optometry" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <div class="">
                    <div class="modal-body  pb0 ">
                       ...
                       <td class="fnt"><?php echo $result['patient_name']; ?></td>
                    ...
                    echo $this->customlib->getPatientAge($result['age'],$result['month'],$result['day']);
                       ...
                       <td class="fnt"><?php echo $result["gender"] ?></td>
                    </tr>
                    </table>
                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name='complaints[]' id="complaints" class="form-control select2 complaints_data" style="width:100%">
                                                        <option value="">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="">Duration</label>
                                                    <input type="text" class="form-control" name="complaints_duration[]" id="complaints_duration" class="duration" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Period</label>
                                                <select name='complaints_period[]' id="complaints_period" class="form-control select2 complaints_period" style="width:100%">
                                                       <option value="">
                                                            <?php echo $this->lang->line('select'); ?>
                                                        </option> 
                                                        <?php
                                                 $Period_data = array("Days","Months","Years");
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name='complaints_type[]' id="complaints_type" class="form-control select2 complaints_type" style="width:100%">
                                                <option value="">
                                                            <?php echo $this->lang->line('select'); ?>
                                                </option> 
                                                <?php
                                                 $complaints_type = array("OD","OS","General","Both");
                                                 foreach($complaints_type as $row):
                                                  echo "<option value='".$row."'>".$row."</option>";
                                                  endforeach;
                                                 ?> 
                                                </select>
                                    ...
                                    <table class="table table-bordered table_dry_retinoscope">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>OD</th>
                                                    <td>
                                                        <input name='drs_od_sph' id="drs_od_sph" class="form-control drs_od_sph" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='drs_od_cyl' id="drs_od_cyl" class="form-control drs_od_cyl" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='drs_od_axis' id="drs_od_axis" class="form-control drs_od_axis" style="width:100%"/>
                                                ...
                                                <tr>
                                                    <th>OS</th>
                                                    <td>
                                                        <input name='drs_os_sph' id="drs_os_sph" class="form-control drs_os_sph" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='drs_os_cyl' id="drs_os_cyl" class="form-control drs_os_cyl" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='drs_os_axis' id="drs_os_axis" class="form-control drs_os_axis" style="width:100%"/>
                                                        <!-- ° -->
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th class="head">OD</th>
                                                    <td>
                                                        <input name='cyclo_od_sph' id="cyclo_od_sph" class="form-control cyclo_od_sph" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='cyclo_od_cyl' id="cyclo_od_cyl" class="form-control cyclo_od_cyl" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='cyclo_od_axis' id="cyclo_od_axis" class="form-control cyclo_od_axis" style="width:100%"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="head">OS</th>
                                                    <td>
                                                        <input name='cyclo_os_sph' id="cyclo_os_sph" class="form-control cyclo_os_sph" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input  name='cyclo_os_cyl' id="cyclo_os_cyl" class="form-control cyclo_os_cyl" style="width:100%"/>
                                                    </td>
                                                    <td>
                                                        <input name='cyclo_os_axis' id="cyclo_os_axis" class="form-control cyclo_os_axis" style="width:100%"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                              ...
                              <table class="table table-bordered table_pgp">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input name='pgp_od_cyl' id="pgp_od_cyl" class="form-control pgp_od_cyl" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='pgp_od_axis' id="pgp_od_axis" class="form-control pgp_od_axis" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input  type="text" name='pgp_od_add' id="pgp_od_add" class="form-control pgp_od_add" style="width:100%"/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name='pgp_os_cyl' id="pgp_os_cyl" class="form-control pgp_os_cyl" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input  type="text" name='pgp_os_axis' id="pgp_os_axis" class="form-control pgp_os_axis" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input type="text" name='pgp_os_add' id="pgp_os_add" class="form-control pgp_os_add" style="width:100%"/>
                                            </td>
                                            <td>
                            ...
                            <table class="table table-bordered table_acceptance">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="head">OD</th>
                                            <td>
                                                <input name='accp_od_sph' id="accp_od_sph" class="form-control accp_od_sph" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='accp_od_cyl' id="accp_od_cyl" class="form-control accp_od_cyl" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='accp_od_axis' id="accp_od_axis" class="form-control accp_od_axis" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='accp_od_add' id="accp_od_add" class="form-control accp_od_add" style="width:100%"/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <th class="head">OS</th>
                                            <td>
                                                <input name='accp_os_sph' id="accp_os_sph" class="form-control accp_os_sph" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='accp_os_cyl' id="accp_os_cyl" class="form-control accp_os_cyl" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='accp_os_axis' id="accp_os_axis" class="form-control accp_os_axis" style="width:100%"/>
                                            </td>
                                            <td>
                                                <input name='accp_os_add' id="accp_os_add" class="form-control accp_os_add" style="width:100%"/>
                                            </td>
                                             <td>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.addnewcomplaints', function(e) {
            ...
            var strR = randomStr();
            var html = '<div class="row ' + strR + '">';
            html += '<div class="col-md-3"><div class="form-group"><select name="complaints[]" id="complaints" class="form-control select2 complaints_data" style="width:100%"><option value=""><?php echo $this->lang->line('select'); ?></option><?php foreach ($complaints_data as $dkey => $dvalue) { ?><option value="<?php echo $dvalue->master_value; ?>"><?php echo $dvalue->master_value; ?></option><?php } ?></select></div></div>';
            html += '<div class="col-md-2"><div class="form-group"><input type="text" class="form-control" name="complaints_duration[]" id="complaints_duration" class="duration" /></div></div><div class="col-md-3"><div class="form-group"><select name="complaints_period[]" id="complaints_period" class="form-control select2 complaints_period" style="width:100%"><option value="Days">Days</option><option value="Months">Months</option>';
            html += '<option value="Years">Years<option></select></div></div>';
            html += '<div class="col-md-3"><div class="form-group"><select name="complaints_type[]" id="complaints_type" class="form-control select2 complaints_type" style="width:100%"><option value=""><?php echo $this->lang->line('select'); ?></option><option value="OD">OD</option><option value="OS">OS</option><option value="Genaral">Genaral</option><option value="Both">Both</option></select></div></div>';
            var deleteC = "deleteComplaints('" + strR + "')";
            html += '<div class="col-md-1"><div onclick="' + deleteC + '"><i class="fa fa-trash" style="color:red" aria-hidden="true"></i></div></div>';
            html += '</div>';
            $('.complaints_container').append(html);
            $('.complaints_data,.complaints_type,.complaints_period').select2();
        });
                ...
                success: function(data) {
                    ...
                    $.each(complaintdata, function(key, value) {
                       <?php $random= rand(); ?> 
                        ...
                        html += '<div class="col-md-3"><div class="form-group"><label for="Complaints"> Complaints</label><select name="complaints[]" id="complaints" class="form-control select2 complaints_data'+key+'" style="width:100%"><option value=""><?php echo $this->lang->line('select'); ?>';
                        <?php foreach ($complaints_data as $dkey => $ddvalue) : ?>
                            if (value.complaints == "<?php echo $ddvalue->master_value; ?>") {
                                html += '<option selected value="<?php echo $ddvalue->master_value; ?>"><?php echo $ddvalue->master_value; ?></option>';
                            } else {
                                html += '<option  value="<?php echo $ddvalue->master_value; ?>"><?php echo $ddvalue->master_value; ?></option>';
                            }
                        <?php endforeach; ?>
                        html += '</select></div></div>';
                        html += '<div class="col-md-2"><div class="form-group"><label for="">Duration</label><input type="text" class="form-control" name="complaints_duration[]" id="complaints_duration" class="duration" value="'+value.complaints_duration+'" /></div></div>';
                        html += '<div class="col-md-3"><div class="form-group"><label for="">Period</label><select name="complaints_period[]" id="complaints_period" class="form-control select2 complaints_period" style="width:100%"><option value=""><?php echo $this->lang->line('select'); ?></option>';
                        <?php
                            $Period_data = array("Days","Months","Years");
                            foreach($Period_data as $row):
                           ?>     
                            if (value.complaints_period == "<?php echo $row; ?>") {
                                html += '<option selected value="<?php echo $row; ?>"><?php echo $row; ?></option>';
                            } else {
                                html += '<option  value="<?php echo $row; ?>"><?php echo $row; ?></option>';
                            }
                        <?php endforeach; ?>
                        html +='</select></div></div>';
                        html +='<div class="col-md-3"><div class="form-group"><label for="">Complaints type</label><select name="complaints_type[]" id="complaints_type" class="form-control select2 complaints_type'+key+'" style="width:100%"><option value=""><?php echo $this->lang->line('select'); ?></option>';
                        <?php
                        $complaints_type = array("OD","OS","General","Both");
                        foreach($complaints_type as $row):
                         ?>   
                        if (value.complaints_type == "<?php echo $row; ?>") {
                                html += '<option selected value="<?php echo $row; ?>"><?php echo $row; ?></option>';
                            } else {
                                html += '<option  value="<?php echo $row; ?>"><?php echo $row; ?></option>';
                            }
                        <?php endforeach; ?> 
                        html +='</select></div></div>';
                        var deleteRow = "deleteComplaints('row_" + key + "')";
                        html +='<div class="col-md-1"><div style="margin-top: 27px;" onclick="' + deleteRow + '"><i class="fa fa-trash" style="color:red" aria-hidden="true"></i></div></div>';
                        html += '</div>';
                        key++;
                    })
                    //html +='<button class="btn btn-primary addnewcomplaints" autocomplete="off"><i class="fa fa-plus" aria-hidden="true"></i>Add</button>';
                    $('.complaints_container').html(html);
                    //$(".complaints_data,.complaints_type").select2();
                    //
                    var html = "";
                    $.each(history_data, function(key, value) {
                        ...
                        if (key == 0) {
                            html += '<div class="col-md-3"><div class="form-group"><label for=" ">Notes</label><div><input type="text" name="condition[]" id="condition" class="form-control select2 condition" value="' + value.condition + '" style="width:100%"></div></div></div>';
                        } else {
                            html += '<div class="col-md-2"><div class="form-group"><label for=" ">Notes</label><div><input type="text" name="condition[]" id="condition" class="form-control select2 condition" value="' + value.condition + '" style="width:100%"></div></div></div>';
    ...
    function complaintMake(indicator, key, value) {
        ...
        if (indicator == "general") {
            if (key in general_complaints) {
                delete general_complaints[key];
            }
            general_complaints[key] = value;
        }
        if (indicator == "both") {
        ...
        var general_html = "";
        $.each(general_complaints, function(general_key, general_value) {
            var param = "'" + general_key + "','general'";
            general_html += '<li class="list-group-item ' + general_key + '_list">' + general_value + '<span class="list_complaint_trash" onclick="deleteComplaint(' + param + ')"><i class="fa fa-trash"></i></span></li>';
        });
        $('.general_complaints ul').html(general_html);

    }

    function deleteComplaint(key, comtype) {
        if (key in os_complaints && key in od_complaints && key in genral_complaints) {
            if (comtype == "od") {
                delete od_complaints[key];
    ...
    function load(opdid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><thead><tr><th>Complaints</th><th>Duration</th><th>Period</th><th>Type</th></tr></thead><tbody>';
                $.each(complaintdata, function(key, val) {
                    html += '<tr><td>' + val.complaints + '</td><td>' + val.complaints_duration +'</td><td>'+val.complaints_period+'</td><td>' + val.complaints_type + '</td></tr>';
                })
                ...
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><thead><tr><th>Tx/Sx</th><th>Duration</th><th>Medication</th><th>Notes</th></tr></thead><tbody>';
               ...
               // Keratometry
                ...
                // Topography
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Topography</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="top_print" value="1" id="top_print" class="opto_print"';
                if(print_data != null && print_data.top_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><th style="width:20%;">Topography</th><td>Sim K</td><td>Min K</td></tr><tr><th>OD</th><td>' + top.top_sli_od + '</td><td>' + top.top_min_od + '</td></tr><tr><th>OS</th><td>' + top.top_sli_os + '</td><td>' + top.top_min_os + '</td></tr></tbody></table></div></div>';


                // Schirmers Test
                html += '<div class="panel panel-default"><div class="panel-heading"><div style="float:left;padding-left:15px">Schirmers Test</div><div style="float:right;padding-right:15px">Print <input type="checkbox"  name="sch_print" value="1" id="sch_print" class="opto_print"';
                if(print_data != null && print_data.sch_print==1){html += 'checked';}
                html += ' /></div><br></div><div class="panel-body"><table class="table table-bordered"><tbody><th style="width:20%;">Schirmers Test</th><td>&nbsp</td><td>mm in 5 Minutes</td><td>&nbsp</td><td>mm in 5 Minutes</td></tr><tr><th>OD</th><td>I</td><td>' + sch.sch_od_mmf + '</td><td>II</td><td>' + sch.sch_od_mms + '</td></tr><tr><th>OS</th><td>I</td><td>' + sch.sch_os_mmf + '</td><td>II</td><td>' + sch.sch_os_mms + '</td></tr></tbody></table></div></div>';
