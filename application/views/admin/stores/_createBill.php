    ...
    ?>
                                    ...
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                ...
                                                <td class="text-right">
                                                    <div class=""> 
                                                            <div class="input-group">
                                                            <input type="text" class="form-control right-border-none product_tax"  name="tax_1" readonly id="tax0"  autocomplete="off">
...
<div class="table-responsive">
        ...
        <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 mtblProducts" id="mTableID">
            ...
            <tr id="mrow1">
                <td>
                    <input type="hidden" name="mtotal_rows[]" value="1">
                    <input type="text" class="form-control" name="mproduct_name[]" id="">
                </td>
                <td >
                    <input type="text" name="mdescription[]"  id="mdescription" class="form-control"/>

                </td> 

                <td class="text-right w-100px">
                    <input type="text" name="mamount[]" id="mamount" placeholder="" class="form-control mamount">
                </td>
                <td>
                        <button type="button"  class="closebtn mdelete_row" data-mrow-id="1" autocomplete="off"><i class="fa fa-remove"></i></button>
                </td>
            </tr>
