...
$currency_symbol = $this->customlib->getHospitalCurrencyFormat();
 ?>
                    <div class="row">
                        ...
                        <input name="stores_bill_basic_id" id="stores_bill_basic_id" type="hidden" class="form-control" value="<?php echo $bill['id']?>" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table tableover table-striped table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                            <thead>
                                            <tr class="font13">
                                                    <th width="12%"><?php echo $this->lang->line('product_category'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th width="12%"><?php echo $this->lang->line('product_name'); ?><small class="req" style="color:red;"> *</small></th>
...
<tr id="row<?php echo $row_value?>">
    ...
    <input type="hidden" class="post_product_category_id" value="<?php echo $bill_detail_value['product_category_id'];?>">
    <input type="hidden" class="post_product_id" value="<?php echo $bill_detail_value['product_id'];?>">
    <input type="hidden" class="post_product_batch_detail_id" value="<?php echo $bill_detail_value['product_batch_detail_id'];?>">
    ...
    <input type="hidden" class="quantity" value="<?php echo $bill_detail_value['quantity'];?>">
         ...
         <option value=""><?php echo $this->lang->line('select'); ?></option>
                    <?php foreach ($productCategory as $med_cat_key => $med_cat_value) {
                        ?>
         <option value="<?php echo $med_cat_value["id"]; ?>" <?php echo set_select('product_category_id_<?php echo $row_value;?>', $med_cat_value['id'], ($med_cat_value["id"] == $bill_detail_value['product_category_id']) ? TRUE :FALSE); ?>><?php echo $med_cat_value["product_category"] ?>
                          </option> 
                      <?php 
                  }
                      ?>
                                                ...
                                                <td width="24%">
                                                    ...
                                                    <select class="form-control select3 product_name" style="width:100%"  id="product_name<?php echo $row_value;?>" name='product_name_id_<?php echo $row_value;?>'>
                    <option value=""><?php echo $this->lang->line('select') ?>
                                    ...
                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                ...
                                                <td class="text-right">
                                                            ...
                                                            <div class="input-group">
                                                            <input type="text" class="form-control right-border-none product_tax"  name="tax_<?php echo $row_value;?>" readonly id="tax<?php echo $row_value;?>"  autocomplete="off">
...
<div class="table-responsive">
        ...
        <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 mtblProducts" id="mTableID">
            <thead>
                <tr class="font13 white-space-nowrap">
                    ...
                    <th width="15%"><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?><small class="req" style="color:red;"> *</small></th>
                    <th class="text-left" width="2%"></th>
                </tr>
            </thead>
            <?php 
            //print_r($bill['manual_products']);
                $mp = json_decode($bill['manual_products']);
                //print_r($mp);
                if(!empty($mp)){
                    $i=0;
                  foreach($mp as $key=>$val):  
            ?>
            <tr id="mrow<?php echo $i; ?>">
                <td>
                    <input type="hidden" name="mtotal_rows[]" value="<?php echo $i; ?>">
                    <input type="text" class="form-control" name="mproduct_name[]" id="" value="<?php echo $val->product_name ?>">
                </td>
                <td >
                    <input type="text" name="mdescription[]"  id="mdescription" class="form-control" value="<?php echo $val->description ?>" />

                </td> 

                <td class="text-right w-100px">
                    <input type="text" name="mamount[]" id="mamount" placeholder="" class="form-control mamount" value="<?php echo $val->amount ?>">
                </td>
                <td>
                        <button type="button"  class="closebtn mdelete_row" data-mrow-id="<?php echo $i; ?>" autocomplete="off"><i class="fa fa-remove"></i></button>
                </td>
            </tr>
            <?php $i++;endforeach; } ?>
        ...
        <a class="btn btn-info addplus-xs madd-record mb10" data-added="0"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add')?></a>  
    </div>
    <div class="divider"></div>
