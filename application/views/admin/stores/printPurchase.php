...
$this->customlib->YYYYMMDDHisTodateFormat($result['date'], $this->customlib->getHospitalTimeFormat());?></h5>
                    ...
                    <div class="table-responsive">
                        <table class="printablea4" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                <th width="20%"><?php echo $this->lang->line('supply_name'); ?></th>
                                <td width="25%"><?php echo $detail[0]["product_category"]; ?></td>
                            ...
                            <tr>
                                ...
                                <td width="25%"><?php echo $result["supply_person"]; ?></td>
                    ...
                    <div class="table-responsive">
                       <table class="printablea4" id="testreport" width="100%">
                        <tr>
                            ...
                            <th width=""><?php echo $this->lang->line('product_name'); ?></th> 
                            ...
                            <th style="text-align: right";>Purchase Quantity</th>
                        ...
                        foreach ($detail as $bill) {
                            ?>
                            <tr>
                                <td width=""><?php echo $bill["product_category"]; ?></td>
                                <td width=""><?php echo $bill["product_name"]; ?></td>
                                ...
                                <td align="right"><?php echo $bill["purchase_quantity"]; ?></td>
                                <td align="right"><?php echo $bill["free"]; ?></td>
...
?>
    <p><label><?php echo $this->lang->line('cheque_no');?> </label> : <?php echo $result["cheque_no"]; ?> <?php if($print == 'no'){ ?><span><a href="<?php echo site_url('admin/stores/downloadcheque/'.$result["id"]); ?>" class='btn btn-default btn-xs' data-toggle='tooltip' title='<?php echo $this->lang->line("download"); ?>'><i class="fa fa-download"></i></a></span><?php } ?></p>
