            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4" style="text-align:left;">
                        <tr>
                            <td width="77%" align="text-left"><h5><?php echo $this->lang->line('bill_no') ?> : <?php echo $this->customlib->getSessionPrefixByType('stores_billing').$result["id"] ?></h5>
                            </td>
                    ...
                    <table class="printablea4" id="testreport" width="100%" style="text-align:left;">
                        <tr>
                            <!--<th width="20%" ><?php echo $this->lang->line('product_category'); ?></th>-->
...
foreach ($detail as $bill) {
    ...
    ?>
                            <tr>
                                <!--<td width="20%" style="text-align:left;"><?php echo $bill["product_category"]; ?></td>-->
                                <td width="20%"><?php echo $bill["product_name"]; ?></td>
                                <td><?php echo $bill["batch_no"]; ?></td>
                                <!--<td><?php echo $bill["unit"]; ?></td>-->
                                <td><?php echo $this->customlib->getProduct_expire_month($bill['expiry']); ?></td>
                                <td><?php echo amountFormat($bill['sale_price']); ?></td>
...
?>
    ...
    <table class="printablea4" id="testreport" width="100%" style="text-align:left;">
        ...
        <?php
        $mproducts = json_decode($result["manual_products"]);
          if(!empty($mproducts)){
            foreach($mproducts as $key=>$val):
            ?>
            <tr>
...
?>
                    ...
                    <table align="right" class="printablea4">
                        <?php if (!empty($result["total"])) {?>
                            <tr>
                                <th style="width: 50%;text-align:right"><?php echo $this->lang->line('total') . " (" . $currency_symbol . ")"; ?></th>
    ...
    ?>
                            <tr>
                                <th style="width: 50%; text-align:right"><?php echo $this->lang->line('discount') . " (" . $currency_symbol . ")";   ?></th>
    ...
    ?>
                            <tr>
                                <th style="width: 50%; text-align:right"><?php
...
?>
                            <tr>
                                <th style="width: 50%; text-align:right"><?php echo $this->lang->line('paid_amount') . " (" . $currency_symbol . ")";  ?></th>
                                <td style="width: 50%; text-align:right" class="text-right"><?php echo amountFormat($result["paid_amount"]); ?></td>

                            </tr>
                            <tr>
                                <th style="width: 50%; text-align:right"><?php echo $this->lang->line('refund_amount') . " (" . $currency_symbol . ")";  ?></th>
