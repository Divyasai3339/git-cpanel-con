            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('stores_bill_report'); ?></h3>
                    </div>
                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('stores_bill_report'); ?></div>
                            <table class="table table-striped table-bordered table-hover allajaxlist" data-export-title="<?php echo $this->lang->line('stores_bill_report'); ?>">
                                <thead>
                                    <tr>
...
( function ( $ ) {
    ...
    $(document).ready(function () {
       $('#form1').on('submit', (function (e) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/stores/checkvalidation',
            type: "POST",
            data: formData,
            dataType: 'json',
            contentType: false,
            ...
            success: function (data) {
                if (data.status == "fail") {
                   $.each(data.error, function(key, value) {
                    ...
                    initDatatable('allajaxlist', 'admin/stores/storesreports/',data.param,[],100,
                        [
