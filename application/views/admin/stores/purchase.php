            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('product_purchase_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('product_purchase', 'can_add')) { ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i> <?php echo $this->lang->line('purchase_product'); ?></a> 
                            <?php } ?>

                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('product_purchase_list'); ?></div>
                        <table class="table table-striped table-bordered table-hover ajaxlist" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('product_purchase_list'); ?>">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo $this->lang->line('net_amount')." (".$currency_symbol.")"; ?></th>z
                 ...
                 <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-9">
                     <div class="p-2 select2-full-width">
                        <select name="supply_id" class="form-control select2 supply_select2"  id="" name='' >
                                <option value=""><?php echo $this->lang->line('select_supply'); ?></option>
                                <?php foreach ($supplyCategory as $dkey => $dvalue) {
                                    ?>
                                    <option value="<?php echo $dvalue["id"]; ?>" <?php
                                    if ((isset($supply_select)) && ($supply_select == $dvalue["id"])) {
                                        echo "selected";
                                    }
                                    ?>><?php echo $dvalue["supply"]; ?></option>   
                            <?php } ?>
                            </select>
                      ...
                      <div class="col-lg-1 col-sm-6">
                        <span id="batchdata" style="color:white"></span>
                    </div> 
                 </div>
            </div><!--./modal-header-->
                                ...
                                <div class="row">
                                    <div class="col-sm-2" hidden>
                                        <div class="form-group">
                                            <label><th><?php echo $this->lang->line('supply_person'); ?></th></label>
                                            <small class="req"> *</small> 
                                            <input name="supply_name" readonly hidden id="supply_name" type="text" class="form-control"/>
                                            <span class="text-danger"><?php echo form_error('supply_name'); ?></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table tableover table-striped table-bordered table-hover mb10 tablefull12" id="tableID">
                                                ...
                                                <tr class="white-space-nowrap">
                                                    <th  width="10%"><?php echo $this->lang->line('product_category'); ?><small class="req"> *</small></th>
                                                    <th  width="10%"><?php echo $this->lang->line('product_name'); ?><small class="req" style="color:red;"> *</small></th>
                                                    ...
                                                    <th><?php echo $this->lang->line('purchase_quantity'); ?><small class="req"> *</small></th>
                                                ...
                                                <tr id="row0" class="white-space-nowrap">
                                                    <td>      
                                                        <select class="form-control" name='product_category_id[]'  onchange="getproduct_name(this.value, '0')">
                                                    ...
                                                    <td>
                                                        <select class="form-control select2" style="width:100%" onchange="getproductdetails(this.value, 0)" id="product_name0" name='product_name[]'>
                                                    ...
                                                    <td>
                                                        <input type="text"  name="batch_no[]" id="batchno0" onchange="getBatchNo(0)" class="form-control">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="batch_amount[]" id="batch_amount" class="form-control">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" name="purchase_quantity[]" onchange="purchase_quantity(0)"  id="purchase_quantity0" class="form-control text-right">
                                                        </div>
                                                    </td>
                                                
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" name="free[]" onchange="free(0)"  id="free0" class="form-control text-right">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" readonly name="quantity[]" onchange="multiply(0)"  id="quantity0" class="form-control text-right">
                                                        </div> 
                                                    </td>
                                                    <td class="text-right">
            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="d-flex align-items-center align-content-center align-items-start flex-column label-0 mobile-p-2">
                    <div class="p-2 d-inline-flex mobile-p-2 form-group mb0">
                        <select style="width:200px;" onchange="get_SupplyDetails(this.value)" class="form-control select2" id="editsupply" name='supply' >
                            <option value=""><?php echo $this->lang->line('select_supply'); ?></option>
                            <?php foreach ($supplyCategory as $dkey => $dvalue) { ?>
                                <option value="<?php echo $dvalue["id"]; ?>" <?php
                                        if ((isset($supply_select)) && ($supply_select == $dvalue["id"])) {
                                        ...
                                        ?>><?php echo $dvalue["supply_category"]; ?></option>   
                         <?php } ?>
                        </select>
                        <span class="text-danger"><?php echo form_error('refference'); ?></span>
                    </div>
                    ...
                    <div class="p-2 mobile-p-2">
                        <input name="date" id="dateedit_supply"  type="text" value="" class="form-control datetime"/>
...
<script>
            ...
            function purchase_quantity(val){
     $('#quantity'+val).val('');
    var pq=$('#purchase_quantity'+ val).val();
    var free=$('#free'+val).val();
    
      if(free==""){
       // alert("dsad");
         var quantity=parseInt(pq);
             $('#quantity'+val).val(parseInt(quantity));

    }
    else
    {
         var quantity=parseInt(pq)+parseInt(free);
             $('#quantity'+val).val(parseInt(quantity));
...
function free(val){
    ...
    if(pq==""){
        alert("dsad");
         var quantity=parseInt(free);
             $('#quantity'+val).val(parseInt(quantity));

    }
    else
    {
         var quantity=parseFloat(pq)+parseFloat(free);
             $('#quantity'+val).val(parseInt(quantity));
            ...
            function getproduct_name(id, rowid) {
                var div_data = "";
                $("#product_name" + rowid).html("<option value='l'><?php echo $this->lang->line('loading') ?></option>");
                $('#product_name' + rowid).select2("val", 'l');
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/stores/get_product_name',
                    type: "POST",
                    ...
                    success: function (res) {
                        ...
                        {
                            var sel = "";
                            div_data += "<option value=" + obj.id + ">" + obj.product_name + "</option>";
                        });
                        $("#product_name" + rowid).html("<option value=''>Select</option>");
                        $('#product_name' + rowid).append(div_data);
                        $('#product_name' + rowid).select2("val", '');
                    }
                });
            }          

            function get_SupplyDetails(id) {
                $("#supply_name").html("supply_name");
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/stores/supplyDetails',
                    type: "POST",
                    data: {id: id},
                    dataType: 'json',
                    success: function (res) {
                        console.log(res);
                        if (res) {
                            $('#supply_name').val(res.supply_person);
                            $('#supplyid').val(res.id);
                        } else {
                            $('#supply_name').val('Null');
            ...
            function getBatchNo(id){
                var batch=$('#batchno'+id).val();
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/stores/getBatchNumber/',
                    type: "POST",
                    data: {batchno: batch},
                    dataType: 'json',
                    success: function (res) {
                        if(res.batch_no){
                        $('#batchdata').html(res.batch_no);
                    }
                    else
                    {
                         $('#batchdata').html("No Batch Found");
                    }
            ...
            function addMore() {
                ...
                var div = "<td><select class='form-control' name='product_category_id[]' onchange='getproduct_name(this.value," + id + ")'><option value='<?php echo set_value('product_category_id'); ?>'><?php echo $this->lang->line('select') ?></option><?php foreach ($productCategory as $dkey => $dvalue) { ?><option value='<?php echo $dvalue["id"]; ?>'><?php echo $dvalue["product_category"] ?></option><?php } ?></select></td><td><select class='form-control select2' style='width:100%' name='product_name[]' onchange='getproductdetails(this.value," + id + ")' id='product_name" + id + "' ><option value='<?php echo set_value('product_name'); ?>'><?php echo $this->lang->line('select') ?></option></select></td><td><input type='text' onchange='getBatchNo("+id+")' name='batch_no[]' id='batchno" + id + "' class='form-control batch_no'></td><td><input type='text' name='expiry_date[]' id='expiry" + id + "' class='form-control expiry_date'></td><td><input type='text' name='mrp[]' id='mrp" + id + "' class='form-control mrp'></td><input type='hidden' name='batch_amount[]' id='batch_amount" + id + "' class='form-control mrp'><td><input type='text' name='sale_rate[]' id='salerate" + id + "' class='form-control sale_rate'></td><td><input type='text' name='packing_qty[]' id='packingqty" + id + "' class='form-control packing_qty'></td><td><div class='input-group'><input type='text' name='purchase_quantity[]' id='purchase_quantity"+ id +"' onchange='purchase_quantity("+ id +")' class='form-control text-right' /></div></td><td><div class='input-group'><input type='text' name='free[]' id='free"+ id +"' onchange='free("+ id +")' class='form-control text-right' /></div></td><td><div class='input-group'><input type='text' name='quantity[]' onchange='multiply(" + id + ")' onfocus='getQuantity(" + id + ")' id='quantity" + id + "' class='form-control text-right'></div></td><td><input type='text' onchange='multiply(" + id + ")' name='purchase_price[]' id='purchase_price" + id + "'  class='form-control text-right'></td><td><div class=''><div class='input-group'><input type='text' change='multiply(" + id + ")' class='form-control right-border-none'  name='purchase_tax[]' id='purchase_tax" + id + "'  autocomplete='off'><span class='input-group-addon '> %</span></div></div></td><td><input type='text' name='amount[]' id='amount" + id + "'  class='form-control text-right'></td>";var row = table.insertRow(table_len).outerHTML = "<tr id='row" + id + "'>" + div + "<td><button type='button' onclick='delete_row(" + id + ")' class='closebtn'><i class='fa fa-remove'></i></button></td></tr>";
                $('.select2').select2();
            ...
            $(document).ready(function (e) {
                $("#bill").on('submit', (function (e) {
                    ...
                    var rowCount = table.rows.length;
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/stores/addBillSupply',
                        type: "POST",
            ...
            function viewDetail(id) {
                $.ajax({
                    url: '<?php echo base_url() ?>admin/stores/getSupplyDetails/' + id,
                    type: "GET",
                    data: {},
                    success: function (data) {
                        $('#reportdata').html(data);                        
                        $('#edit_deletebill').html("<?php if($this->rbac->hasPrivilege('product_purchase', 'can_view')) { ?><a href='#' data-toggle='tooltip' data-placement='bottom' onclick='printData(" + id + ")' data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a> <?php } ?><?php if($this->rbac->hasPrivilege('product_purchase', 'can_delete')) { ?><a onclick='delete_bill(" + id + ")'  href='#'  data-toggle='tooltip' data-placement='bottom' data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");                        
                        holdModal('viewModal');
                    },
                });
            }
            ...
            function multiply(id) {
                var quantity = $('#purchase_quantity' + id).val();
            ...
            function getExpire(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "admin/stores/getExpiryDate",
            ...
            function getproductdetails(id, rowid) {
                $.ajax({
                    type: "POST",
                    url: base_url + "admin/stores/getproductdetails",
                    data: {'stores_id': id},
                    dataType: 'json',
                    success: function (res) {
                         if (res) {
            ...
            function get_PatientDetails(id) {
                ...
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/stores/patientDetails',
                    type: "POST",
                    data: {id: id},
                    dataType: 'json',
                    success: function (res) {
 ...
 $("#myModal").on('hidden.bs.modal', function(){
    ...
    $("select[id^='product_name']").select2("val", "");
    $(".supply_select2").select2("val", "");
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/stores/getstorespurchaseDatatable',[],[],100,
            [
...
<script type="text/javascript">
    function delete_bill(id) {
        if (confirm('<?php echo $this->lang->line('delete_confirm'); ?>')) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/stores/deleteSupplyBill/' + id,
                success: function (res) {
    ...
    function printData(id) {
        ...
        $.ajax({
            url: base_url + 'admin/stores/getSupplyDetails/' + id,
            type: 'POST',
