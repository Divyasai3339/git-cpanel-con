            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('import_product', 'can_view')) { ?>       
                                <a href="<?php echo site_url('admin/stores/exportformat') ?>">
                    ...
                    <div class="box-body">      
                        ...
                        <br/>           
                        <p><b><?php echo $this->lang->line('note') ?>:</b> <?php echo $this->lang->line('product_import_note'); ?> </p>
                        <hr/>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    foreach ($fields as $key => $value) {
                                        ...
                                        if ($value == 'product_company') {
                                            $value = "company";
                                        }
                                        if ($value == 'product_composition') {
                                            $value = "composition";
                                        }
                                        ...
                                        $add = "";
                                        if (($value == "product") || ($value == "company") || ($value == "composition") || ($value == "group") || ($value == "re_order_level")) {
                    ...
                    <form action="<?php echo site_url('admin/stores/import') ?>" id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="product_category_id" name="product_category_id" class="form-control" >
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php
                                            foreach ($productCategory as $product) {
                                                ?>
                                                <option value="<?php echo $product['id'] ?>"><?php echo $product['product_category'] ?></option>
                                                <?php
                                                $count++;
                                            }
                                            ?>
                                    ...
                                    <input type="hidden" id="id" name="productid">
                                </div>
                                ...
                                <div class="col-md-12 pt20">
                                    ...
                                    <button type="submit" class="btn btn-info btn-sm pull-right"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_product'); ?></button>
                                </div>     
...
<script type="text/javascript">
            ...
            $(document).ready(function (e) {
                $("#formimp").on('submit', (function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/stores/import',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.product_image != "") {
                            $("#product_image").attr('src', '<?php echo base_url() ?>' + data.product_image);
                        } else {
                            $("#product_image").attr('src', '<?php echo base_url() ?>uploads/product_images/no_product_image.png');
