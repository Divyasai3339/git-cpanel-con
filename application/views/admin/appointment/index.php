              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <?php echo $this->lang->line('optometrist'); ?></label>
                      <div>
                        <select class="form-control"  style="width:100%" name="optometrist" id="optometrist" >
                          <option value="<?php echo set_value('optometrist'); ?>"><?php echo $this->lang->line('select') ?></option>
                          <?php foreach ($optometrist as $dkey => $dvalue) {
                          ?>
                          <option value="<?php echo $dvalue["id"]; ?>"><?php echo $dvalue["name"] . " " . $dvalue["surname"]." (".$dvalue["employee_id"].")" ?></option>
                          <?php }?>
                        </select>
                        <span class="text-danger"><?php echo form_error('optometrist'); ?></span>
                      </div>
                    </div>
                  </div>
                <div class="col-sm-3">
                ...
                <div class="row">
                  <input type="hidden" name="appointment_id" id="appointment_id">
                    <input type="hidden" name="patient_id" id="patient_id">
                     <input type="hidden" name="charge_id" class="charge_id">
...
function getBed(bed_group, bed = '', active, htmlid = 'bed_no') {
    ...
    function viewreschedule(id,patient_id){
      ...
      $.ajax({
        ...
        type: "GET",
        data: {appointment_id: id,patient_id:patient_id},
        dataType: 'json',
        success: function (data) {
            // alert("working 1")
