            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('complaints_list'); ?></h3>
                        <div class="box-tools pull-right"> 
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm complaints"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_complaints'); ?></a>    
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('complaints'); ?></th>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_complaint'); ?></h4> 
            </div>
            <form id="formadd" action="<?php echo site_url('admin/complaints/add') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('complaints'); ?></label><small class="req"> *</small>
                            <input autofocus="" id="name" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('complaints'); ?>" />
