    ...
    else
    {
         var quantity=parseFloat(pq)+parseFloat(free);
            ...
            function getBatchNo(id){
                ...
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/pharmacy/getBatchNumber/',
                    type: "POST",
                    data: {batchno: batch},
                    dataType: 'json',
                    success: function (res) {
