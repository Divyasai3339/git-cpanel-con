                ...
                <div class="modalicon"> 
                    ...
                    <div id='edit_delete'>
                        ...
                        <?php if ($this->rbac->hasPrivilege('revisit', 'can_edit')) { ?>
                            <a href="#" data-placement="bottom" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" ><i class="fa fa-pencils"></i></a>
                            <?php
                        }
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="pwd"><?php echo 'Bio Hazard'; ?></label>
                                                <input id="ebiohazard" autocomplete="off" name="biohazard"  type="text" placeholder="" class="form-control"  value="<?php echo set_value('biohazard'); ?>" />
                                            </div>
                                        </div> 
