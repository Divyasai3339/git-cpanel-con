                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('ipd_patient', 'can_add')) { ?>
                                <a data-toggle="modal" onclick="holdModal('surgery_filter')" id="addp1" class="btn btn-primary btn-sm addpatient"><i class="fa fa-clock-o"></i> Plant Surgeries</a> 
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('ipd_patient', 'can_add')) { ?>
...
<div class="modal fade bd-example-modal-lg" id="surgery_filter" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
       <div class="modal-header theme-modal-header">
        ...
        <h4 class="modal-title display-inline" id="exampleModalLabel">Plant Surgeries</h4>
      </div>
      <div class="modal-body pt0 pb0">
        <div class="row">
            <div class="col-md-7">
                <div class="row">
                 <form role="form" id="surgery_form" method="post" action="<?php echo base_url('admin/optometry/exportsurgeries'); ?>" class="">   
                  <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label for="">Export</small></label> <br>
                        <div><button type="button" class="btn btn-primary btn-sm export_surgeries"><i class="fa fa-file-excel-o"></i></button></div>
                    </div>
                  </form>  
                </div>    
            </div>
...
<script>
    ...
    $(document).on('click','.export_surgeries',function(){
        var ot=$('#ot').val()
