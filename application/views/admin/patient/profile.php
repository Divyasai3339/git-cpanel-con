                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-12">
                                            <table class="table table-bordered mb0">
                                                <tr>
                                                    <td class="bolds"><?php echo 'Gender/Age'; ?></td>
                                                    <td><?php echo $result['gender'] .'/' .$this->customlib->getPatientAge($result['age'], $result['month'], $result['day']); ?></td>
                                                </tr>
                                                <tr>
...
<tr>
                                                    <td class="bolds"><?php echo 'Bio Hazard' ?></td>
                                                    <td style="color:red !important;"><?php echo $result['biohazard']; ?></td>
                                                </tr>
                                    ...
                                    <ul>
                                        ...
                                        if (!empty($patientdetails['patient']['findings'])) {
                                            foreach ($patientdetails['patient']['findings'] as $row) {
                                             $findarray = json_decode($row['finding_description']);}?>        <?php     foreach($findarray as $find){
                                           
                                            $finddata = $this->finding_model->getfindingcategory($find->finding_type_id); 
                                            
                                            ?>                                    <li>
                                        <div><?php print_r($finddata['category'] );?>  - <?php $desc =  print_r(str_replace(array('[',']','"'),'',$find->finding_description)); ?></div>
                                                </li>
                                        <?php }}
                                         ?>
                                    </ul>
