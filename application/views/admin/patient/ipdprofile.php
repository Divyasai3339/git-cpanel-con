...
$iolmodellist = $this->operationtheatre_model->iolmodel_list();
$ioltypelist = $this->operationtheatre_model->ioltype_list();
$axiallist = $this->operationtheatre_model->axial_list();
$constantlist = $this->operationtheatre_model->constant_list();
$powerlist = $this->operationtheatre_model->power_list();
$optinlist = $this->operationtheatre_model->optin_list();
$acpclist = $this->operationtheatre_model->acpc_list();
?>
                        ...
                        <ul class="nav nav-tabs navlistscroll">
                            ...
                            <?php if ($this->rbac->hasPrivilege('ipd_medication', 'can_view')) {  ?>
                                <li>
                                    ...
                                    <a href="#consumable" class="medication" data-toggle="tab" aria-expanded="true"><i class="fas fa-cut" aria-hidden="true"></i> <?php echo "Consumable"; ?></a>
                                </li>
                            <?php } ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                        <div class="box-header border-b mb10 pl-0 pt0"> 
                                           ...
                                           <div class="pull-right">
                                                ...
                                                <a class="patient_prep" href="#" data-toggle="tooltip" title="<?php echo 'Prep-op'; ?>"><i class="fa fa-plus"></i>
                                    </a> 
        ...
        <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($consultant_value['date'],$this->customlib->getHospitalTimeFormat()); ?></td>
                        ...
                        <?php } ?>  
                          ...
                          <?php if ($this->rbac->hasPrivilege('ipd_timeline', 'can_view')) { ?>  
                            <div class="tab-pane tab-content-height" id="timeline">
                                <div class="box-tab-header">
                                    ...
                                    <div class="box-tab-tools">
                                          ...
                                          <!-- <a href="#timeline"  class="btn btn-sm btn-primary print_consentform" data-toggle="tab" aria-expanded="true"><i class="fa fa-print"></i> <?php echo 'Consent Form '; ?></a> -->

                                          <a class="btn btn-sm btn-primary patient_consent"  href="#timeline" data-toggle="tooltip" title="<?php echo 'patient_consent'; ?>"><i class="fa fa-plus"> <?php echo ' Consent Form '; ?></i>
                                    </a> 
                            ...
                            <?php if ($this->rbac->hasPrivilege('bed_history', 'can_view')) {  ?>
                              ...
                              <!-- consumable -->
                              <?php if ($this->rbac->hasPrivilege('ipd_medication', 'can_view')) {  ?>
                                <div class="tab-pane tab-content-height" id="consumable">
                                    <div class="box-tab-header">
                                        <h3 class="box-tab-title"><?php echo 'Consumable'; ?></h3>
                                        <div class="box-tab-tools">
                                        <?php if($is_discharge) { if ($this->rbac->hasPrivilege('ipd_medication', 'can_add')) {  ?>
                                            <a href="" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm addissueitem" ><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_item'); ?></a>
                                        <?php } }?>
                                        </div>    
                                   </div><!--./box-tab-header-->  
                                   <div class="table-responsive">
                                    ...
                                    <tbody id="">
                                        ...
                                        foreach($consumables as $row ){ 
                                            $action = "";
                                            $action .= "<a href='#' onclick='viewConsumableBillDetail(" . $row['id'] . ")' class='btn btn-default btn-xs' data-toggle='tooltip' title='" . $this->lang->line('show') . "' ><i class='fa fa-reorder'></i></a>";
                                            $action .= "<a href='#'  data-loading-text='" . $this->lang->line('please_wait') . "' data-record-id='" . $row['id'] . "' class='btn btn-default btn-xs print_consumablebill' data-toggle='tooltip' title='" . $this->lang->line('print') . "' ><i class='fa fa-print'></i></a>";
                                        ?>
                                            <tr>
                                            <td><?php echo "PHAB".$row['id']; ?></td>
                                            <td><?php echo $row['case_reference_id']; ?></td>
                                            
                                            <td><?php echo "IPDN".$row['ipd_id']; ?></td>
                    ...
                    <td class="text-right"><?php echo "(".$charge["tax"]."%) ".$taxamount; ?></td> 
                                                        ...
                                                        <td class="text-right"><?php echo number_format($charge["apply_charge"], 2) ?></td>
                                                            <!-- ds -->
                                                              <td class="text-right"><?php echo number_format($charge["discount"], 2) ?></td>
...
<div class="modal fade" id="patient_prep" role="dialog" aria-labelledby="follow_up">   
    <div class="modal-dialog modal-mid modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close"  data-dismiss="modal">&times;</button>
               <div class="modalicon"> 
                     <div id='allpayments_print_prep'>
                    </div>
                </div>
                <h4 class="modal-title"><?php echo 'Prep-op'; ?></h4>
            </div>
            <div class="modal-body pb0" id="patient_prep_result">
...
<div class="modal fade" id="patient_consent" role="dialog" aria-labelledby="follow_up">   
    <div class="modal-dialog modal-mid modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close"  data-dismiss="modal">&times;</button>
               <div class="modalicon"> 
                     <div id='allpayments_print_consent'>
                    </div>
                </div>
                <h4 class="modal-title"><?php echo 'Consent form Details'; ?></h4>
            </div>
            <div class="modal-body pb0" id="patient_consent_result">
...
<select name="operation_category" id="operation_category" class="form-control select2" onchange="getcategory(this.value)" style="width:100%">
        ...
        <input type="text" value="<?php //echo set_value('email');     ?>" id="date" name="date" class="form-control datetime">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo 'Consultation Surgeo'; ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('assistant_consultant'); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Serial NO."; ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "IOL Name"; ?></label>
                                                <input type="text" name="iol_name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "IOL Model"; ?></label> 
                                                <select name="iol_model" id="iol_model" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($iolmodellist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['iolmodel_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('operation_category'); ?></span>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Batch No."; ?></label>
                                                <input type="text" name="batch_no" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "IOL Type"; ?></label> 
                                                <select name="iol_type" id="iol_type" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($ioltypelist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['ioltype_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('ioltype_name'); ?></span>
                                        </div>
                                     </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "Axial Length"; ?></label> 
                                                <select name="axial_length" id="axial_length" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($axiallist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['axial_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('axial_name'); ?></span>
                                        </div>
                                     </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "A Constant"; ?></label>
                                                <select name="a_constant" id="a_constant" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($constantlist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['constant_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('constant_name'); ?></span>
                                        </div>
                                     </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "Power"; ?></label> 
                                                <select name="power" id="power" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($powerlist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['power_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('power_name'); ?></span>
                                        </div>
                                     </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "Optin Dioptor"; ?></label> 
                                                <select name="optin_dioptor" id="optin_dioptor" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($optinlist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['optin_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('optin_name'); ?></span>
                                        </div>
                                     </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo "AC/PC"; ?></label> 
                                                <select name="ac_pc" id="ac_pc" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($acpclist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['acpc_name']; ?></option>
                                                     <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "MFG Date"; ?></label>
                                                <input type="text" name="mfg_date" class="form-control expiry_date" id>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "MRP"; ?></label>
                                                <input type="text" name="mrp" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Invoice No."; ?></label>
                                            ...
                                            <div class="form-group">
                                                <label><?php echo "Start Time"; ?></label>
                                                 <div class="input-group">
                                                        <input type="text" name="start_time" class="form-control timepicker" id="start_time" value="<?php echo set_value('time'); ?>">
                                        ...
                                        <div class="col-sm-6 bootstrap-timepicker">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                        <input type="text" name="end_time" class="form-control timepicker" id="end_time" value="<?php echo set_value('time'); ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Serial NO."; ?></label>
                                                <input type="text" name="serial_no" id="eserial_no" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Manufacturer"; ?></label>
                                                <input type="text" name="manufacturer" id="emanufacturer" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "IOL Name"; ?></label>
                                                <input type="text" name="iol_name" id="eiol_name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "IOL Model"; ?></label> 
                                                <select name="iol_model" id="eiol_model" class="form-control select2" style="width:100%">
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($iolmodellist as $operation){ ?>
                                                    <option value="<?php echo $operation['id']; ?>"><?php echo $operation['iolmodel_name']; ?></option>
                                                <?php } ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Batch No."; ?></label>
                                                <input type="text" name="batch_no" id="ebatch_no" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "IOL Type"; ?></label> 
                                                <select name="iol_type" id="eiol_type" class="form-control select2" style="width:100%">
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($ioltypelist as $operation){ ?>
                                                    <option value="<?php echo $operation['id']; ?>"><?php echo $operation['ioltype_name']; ?></option>
                                                <?php } ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo "Axial Length"; ?></label> 
                                                <select name="axial_length" id="eaxial_length" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($axiallist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['axial_name']; ?></option>
                                                     <?php } ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo "A Constant"; ?></label>
                                                <select name="a_constant" id="ea_constant" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($constantlist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['constant_name']; ?></option>
                                                     <?php } ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo "Power"; ?></label> 
                                                <select name="power" id="epower" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($powerlist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['power_name']; ?></option>
                                                     <?php } ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo "Optin Dioptor"; ?></label> 
                                                <select name="optin_dioptor" id="eoptin_dioptor" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($optinlist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['optin_name']; ?></option>
                                                     <?php } ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo "AC/PC"; ?></label> 
                                                <select name="ac_pc" id="eac_pc" class="form-control select2"style="width:100%">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach($acpclist as $operation){ ?>
                                                        <option value="<?php echo $operation['id']; ?>"><?php echo $operation['acpc_name']; ?></option>
                                                     <?php } ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "MFG Date"; ?></label>
                                                <input type="text" id="emfg_date" name="mfg_date" class="form-control expiry_date">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Expiry Date"; ?></label>
                                                <input type="text" id="eexpiry_date" name="expiry_date" class="form-control expiry_date">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Supplier"; ?></label>
                                                <input type="text" name="supplier" id="esupplier" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Purchase Price"; ?></label>
                                                <input type="text" name="purchase_price" id="epurchase_price" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo "Invoice No."; ?></label>
                                                <input type="text" name="invoice_no" id="einvoice_no" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 bootstrap-timepicker" >
                                            <div class="form-group">
                                                <label><?php echo "Start Time"; ?></label>
                                                 <div class="input-group">
                                                        <input type="text" name="start_time" class="form-control timepicker" id="estart_time" value="<?php echo set_value('time'); ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-6 bootstrap-timepicker">
                                            <div class="form-group">
                                                <label><?php echo "End Time"; ?></label>
                                                <div class="input-group">
                                                        <input type="text" name="end_time" class="form-control timepicker" id="eend_time" value="<?php echo set_value('time'); ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                                        </div>
                                                    </div>
...
<!-- -->
<div class="modal fade" id="viewModalconsent" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
...
<div class="modal fade"  id="myModal" tabindex="-1" role="dialog" aria-labelledby="follow_up">
    <div class="modal-dialog modal-mid pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close"  data-dismiss="modal">&times;</button>
            ...
            <div class="scroll-area">
                <div class="modal-body pt0 pb0" >
                    <div class="row ptt10">
                        <form id="form1" action="<?php echo base_url('admin/issueitem/addconsumable'); ?>"   name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <?php echo $this->customlib->getCSRF(); ?>
                            <input type="hidden" name="ipd_id" value="<?php echo $ipdid; ?>">
                            <input type="hidden" name="patient_id" value="<?php echo $id; ?>">
                            <div class="col-md-12">
                                <!-- <div class="table-responsive"> -->
                                        <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12" id="tableIDS">
                                        <thead>
                                                <tr class="font13 white-space-nowrap">
                                                    <th width="25%">
                                                        <?php echo $this->lang->line('item_category'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th width="25%"><?php echo $this->lang->line('item'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th width="25%"><?php echo $this->lang->line('quantity'); ?> <small class="req" style="color:red;">*</small></th>
                                                </tr>
                                            </thead>
                                            <tr id="row1">
                                                    ...
                                                    <!-- <div class="form-group col-sm-3"> -->
                                                        ...
                                                        <select  id="item_category_id" name="item_category_id_1" class="form-control select3 item_category" style="width:100%">
                                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                            <?php
                                                    ...
                                                    <td>
                                                        ...
                                                        <select  id="item_id" name="item_id_1" class="form-control select3 item_name" data-rowid="1" style="width:100%">
                                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                        </select>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input class="form-control" name="quantity_1"/>
                                                        <span class="text-danger"><?php echo form_error('quantity'); ?></span>
                                                        
                                                        <div id="div_avail1">
                                                            <span><?php echo $this->lang->line('available_quantity'); ?> : </span>
                                                            
                                                            <span id="item_available_quantity_1">0</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                ...
                                <!-- </div> -->
                                <a class="btn btn-info addplus-xs add-records mb10" data-added="0"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add')?></a>  
                            </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-sm-5 mb10">
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4>
                                                        <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" name="charge_discount" id="charge_discount" class="form-control charge_discount"  style="width: 70%; float: right;font-size: 12px;"/>
                                                    </td>
                                                    <td class="text-right ipdbilltable">
                                                        <input type="text" placeholder="discount" name="discount" value="0" id="discount" style="width: 50%; float: right" class="form-control discount" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th></th>
                                                <td colspan="2" class="text-right ipdbilltable">
                                                <button onclick="Calc()"  class="btn btn-info" >Calculate</button>
                                                </td>
                                                </tr>
                                            </table>                                            
                                        </div> 
...
<div class="modal fade" id="ConsumableBillViewModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-toggle="tooltip" title="<?php echo $this->lang->line('clase'); ?>" data-dismiss="modal">&times;</button>
...
<script type="text/javascript">   
    ...
    function addconsumableModal() {        
        holdModal('myaddconsumableModal');
    }
...
$('#myChargesModal').on('hidden.bs.modal', function (e) {
 ...
 $("#add_operationtheatre").on('hidden.bs.modal', function (e) {
    ...
    $(document).ready(function (e) {
        $('#add_prescription,#patient_discharge,#patient_prep,#patient_consent').modal({
        backdrop: 'static',
        keyboard: false,
        show:false
    });
            ...
            success: function (data) {
               ...
               $('#eoperation_category').select2().select2('val',data.category_id);
                ...
                $("#eot_result").val(data.result);
                 $("#eserial_no").val(data.serial_no);
                 $("#emanufacturer").val(data.manufacturer);
                 $("#eiol_name").val(data.iol_name);
                
                 $("#ebatch_no").val(data.batch_no);
                 $("#emfg_date").val(data.mfg_date);
                 $("#eexpiry_date").val(data.expiry_date);
                 $("#esupplier").val(data.supplier);
                 $("#epurchase_price").val(data.purchase_price);
                 $("#emrp").val(data.mrp);
                 $("#einvoice_no").val(data.invoice_no);
                 $("#estart_time").val(data.start_time);
                 $("#eend_time").val(data.end_time);
                 
                 
                  $("#edit_operationtheatre #eiol_model").select2().select2('val', data.iol_model);
                  $("#edit_operationtheatre #eiol_type").select2().select2('val', data.iol_type);
                  $("#edit_operationtheatre #eaxial_length").select2().select2('val', data.axial_length);
                  $("#edit_operationtheatre #ea_constant").select2().select2('val', data.a_constant);
                  $("#edit_operationtheatre #epower").select2().select2('val', data.power);
                  $("#edit_operationtheatre #eoptin_dioptor").select2().select2('val', data.optin_dioptor);
                   $("#edit_operationtheatre #eac_pc").select2().select2('val', data.ac_pc);
...
function delete_prescription(prescription_id) {
    ...
    $(document).on('change keyup input paste','#qty',function(){
        ...
        $('#tax').val(((apply_charge*tax_percent)/100).toFixed(2));
     
        // var discount_percent= 0;
        //    // ds
        // var discount_percent=$('#charge_discount').val(); 
    ...
    //   // ds 
      function Calc() { 
        ...
        var apply_charge = $('#apply_charge').val();
        var discount_percent= 0;
           // ds
        var discount_percent=$('#charge_discount').val(); 
        ...
        else if(discount_amount != "")
        {
            ...
            t_amount = apply_charge - discount_amount;
            alert(t_amount);
            $('#final_amount').val((t_amount.toFixed(2))); 
        } 
    } 
    //ds
...
$(document).on('click','.print_dischargecard',function(){
      ...
      $.ajax({
          ...
          type: "POST",
          data:{'id':record_id,'case_id':case_id,'module_type':'ipd','ipd_id':ipd_id},
          dataType: 'json',
           beforeSend: function() {
                 $this.button('loading');
...
$(document).on('click','.patient_prep',function(){  
           
        var case_reference_id="<?php echo $case_reference_id;?>";
        var payment_modal=$('#patient_prep');
        payment_modal.addClass('modal_loading'); 
        payment_modal.modal('show'); 
        $.ajax({
        url: base_url+'admin/bill/patient_prep/'+case_reference_id,
        type: "POST",
        data:{'module_type':'ipd'},
        dataType: 'json',
        beforeSend: function() {
        ...
        $('.modal-body',payment_modal).html(data.page);
        $('.filestyle','#patient_prep').dropify();
        $('.date','#patient_prep').trigger("change");
        payment_modal.removeClass('modal_loading'); 
        },
...
$(document).on('submit','#patient_prep', function(e){
    e.preventDefault();
    var clicked_btn = $("button[type=submit]");
...
$(document).on('click','.print_prep',function(){
         var $this = $(this);
         var record_id=$this.data('recordId');
         var case_id=$this.data('case_id');   
         var ipd_id=$this.data('ipd_id');   
       ...
       $this.button('loading');
      $.ajax({
          url: '<?php echo base_url(); ?>admin/bill/print_prep',
          type: "POST",
          data:{'id':record_id,'case_id':case_id,'module_type':'ipd','ipd_id':ipd_id},
          dataType: 'json',
           beforeSend: function() {
...
$(document).on('click','.patient_consent',function(){  
           
           var case_reference_id="<?php echo $case_reference_id;?>";
           var payment_modal=$('#patient_consent');
           payment_modal.addClass('modal_loading'); 
           payment_modal.modal('show'); 
           $.ajax({
           url: base_url+'admin/bill/patient_consent/'+case_reference_id,
           type: "POST",
           data:{'module_type':'ipd'},
           dataType: 'json',
           beforeSend: function() {
           ...
           $('.modal-body',payment_modal).html(data.page);
           $('.filestyle','#patient_consent').dropify();
           $('.date','#patient_consent').trigger("change");
           payment_modal.removeClass('modal_loading'); 
           },
   ...
   $(document).on('submit','#patient_consent', function(e){
       e.preventDefault();
       var clicked_btn = $("button[type=submit]");
   ...
   $(document).on('click','.print_consent',function(){
            var $this = $(this);
            var record_id=$this.data('recordId');
            var case_id=$this.data('case_id');   
            var ipd_id=$this.data('ipd_id');   
          ...
          $this.button('loading');
         $.ajax({
             url: '<?php echo base_url(); ?>admin/bill/print_consent',
             type: "POST",
             data:{'id':record_id,'case_id':case_id,'module_type':'ipd','ipd_id':ipd_id},
             dataType: 'json',
              beforeSend: function() {
...
<script type="text/javascript">
    ...
    $(document).on('change', '.item_category', function() {
        getItem($(this), $(this).val(), '');

    });

    function getItem(item_cat_obj, val, item_id) {

        var item_colomn = item_cat_obj.closest('tr').find('.item_name');
        item_colomn.html("");
        $.ajax({
            url: base_url + "admin/itemstock/getItemByCategory",
            type: "GET",
            data:  {'item_category_id': val},
            dataType: 'json',
            beforeSend: function() {
                item_colomn.html("<option value=''><?php echo $this->lang->line('select') ?></option>");
            ...
            success: function(res) {
                ...
                item_colomn.html(div_data);
                item_colomn.val(item_id);
                //item_colomn.select2("val", item_id);
    ...
    $(document).on('change', '.item_name', function() {
        ...
        var row_id_val = $(this).data('rowid');
        $('#item_available_quantity_' + row_id_val).html('');
        $.ajax({
            type: "GET",
            ...
            dataType: 'json',
            success: function(res) {
                $('#div_avail' + row_id_val).show();
                $('#item_available_quantity_' + row_id_val).html(res.available);
...
<script>
    ...
    $(document).on('click','.add-records',function(){
        var rowCount = $('#tableIDS tr').length;
        //var table = document.getElementById("tableIDS");
        //var total_rows=1;
        var id = rowCount;
        var medcat_template=$("#medcat-template").html();
        var div = "<td><input type='hidden' name='rows[]' value='" + id + "'><select class='form-control item_category select3' style='width: 100%;' name='item_category_id_"+id+"' ><option value='<?php echo set_value('item_category_id'); ?>'><?php echo $this->lang->line('select') ?></option>"+medcat_template+"</select></td><td><select id='item_id_" + id + "' class='form-control select3 item_name' data-rowid='"+id+"' style='width: 100%;' name='item_id_"+id+"'><option value='<?php echo set_value('item_id'); ?>'><?php echo $this->lang->line('select') ?></option></select></td><td><input type='text' name='quantity_"+id+"' id='quantity_" + id + "'class='form-control style='width: 80%; text-right'><div id='div_avail"+id+"'><span><?php echo $this->lang->line('available_quantity'); ?> : </span><span id='item_available_quantity_"+id+"'>0</span></div></td>";
       

        var row =  "<tr id='row" + id + "'>" + div + "<td><button style='float:left' type='button' data-row-id='"+id+"' class='closebtn delete_row'><i class='fa fa-remove'></i></button></td></tr>";
        $('#tableIDS').append(row);
        $('.select3').select2();
        //total_rows++;
    ...
    function viewConsumableBillDetail(id) {
        var view_modal=$('#ConsumableBillViewModal');
        $.ajax({
            url: '<?php echo base_url() ?>admin/issueitem/getConsumableBillDetails/',
            type: "GET",
            data: {'id': id},
            dataType:"JSON",
            beforeSend: function(){
                $('#reportdata,#edit_deletebill').html("");
           $('#ConsumableBillViewModal').modal('show');
    ...
    $(document).on('click','.print_consumablebill',function(){
            var $print_btn = $(this);
            var record_id=$(this).data('recordId');
            $.ajax({
            url: '<?php echo base_url() ?>admin/issueitem/getConsumableBillDetails/',
   ...
   if (confirm(message)) {
       $.ajax({
        url: base_url+'admin/issueitem/deleteConsumableBill',
        type: "POST",
        data:{'id':delete_id},
        dataType: 'json',
         beforeSend: function() {
...
$(document).ready(function (e) {
            ...
            $(document).on('click','.print_consentform',function(){
    ...
    var $this = $(this);
     ...
     $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/patient/printConsentform',
        type: "POST",
         data:{'id':record_id,'type':'ipd'},
        dataType: 'json',
         beforeSend: function() {
