                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2 complaintstype" style="width: 100%" name='complaints_type' id="complaints_type">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea name="complaints_description" id="complaints_description" class="form-control"><?php echo set_value('complaints_description', $result->complaints_description) ?> </textarea>
                                            </div>
                                        </td>
                                        ...
                                        <!-- <div class="col-md-3"> -->
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" name="durations[]" id="durations" class="durations" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select name='periods[]' id="periods" class="form-control select2 periods" style="width:100%">
                                                        <option value="Days">
                                                            Days
                                                        </option>
                                                        <option value="Months">
