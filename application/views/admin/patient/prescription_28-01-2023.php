        ...
        <div class="col-md-12">
            ...
            <div class="">
                ...
                <table width="100%" class="printablea4">
                    <tr>
                        <th><?php echo $this->lang->line('prescription'); ?> : <?php echo $this->customlib->getSessionPrefixByType('opd_prescription') . $result->prescription_id; ?></th>
                        <td></td>
                ...
                <?php $history = json_decode($result->history);
                if (!empty($history)) { ?>
                    <h4>History</h4>
                ...
                <table width="100%" class="printablea4 ">
                    <tr>
                        <th width="50%">OPD Procedure</th>
                        <th width="50%">Surgery Recommendations</th>
                    </tr>
                    <tr>
                        <td><?php foreach (json_decode($result->opd_procedure) as $key => $val) { ?>
                                <table width="100%" class="printablea4">
                                    <tr>
                                    <td><span class="text-capitalize"><?php echo str_replace('_',' ',$val); ?></span></td>
                                    </tr>
                                ...
                                <td width="50%"><?php $sl = '';
                                        ...
                                        <table>
                                            <?php if ($test_value->test_name != "") {
                                                        $sl++; ?> <tr>
                                                    <td><?php echo "<b>" . $sl . '</b>. ' . $test_value->test_name . " (" . $test_value->short_name . ")"; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </table>
                                    <?php } ?>
                                    ...
                                    foreach ($result->tests as $test_key => $test_value) {  ?>
                                        <table>
                                            <?php if ($test_value->test_name == "") {
                                                if ($test_value->radio_test_name != '') {
                                                    $slradiology++; ?> <tr>
                                                        <td><?php echo "<b>" . $slradiology . '</b>. ' . $test_value->radio_test_name . " (" . $test_value->radio_short_name . ")"; ?></td>
                                                    </tr>
                                            <?php }
                                            } ?>
                                        </table>
