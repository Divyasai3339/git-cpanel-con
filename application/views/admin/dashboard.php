        ...
        <div class="row">
            ...
            if ($this->module_lib->hasActive('opd')) {
                if ($this->rbac->hasPrivilege('opd_income_widget', 'can_view')) {
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 col20
                         ">
                        <div class="info-box" id="opd_title" >
            ...
            if ($this->module_lib->hasActive('ipd')) {
                if ($this->rbac->hasPrivilege('ipd_income_widget', 'can_view')) {
                    ?>
                    <div id="ipd_title" class="col-lg-2 col-md-3 col-sm-6 col20">
                        <div class="info-box">
            ...
            if ($this->module_lib->hasActive('blood_bank')) {
                if ($this->rbac->hasPrivilege('blood_bank_income_widget', 'can_view')) {
                    ?>
                    <div id="blood_bank_title" class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('blood_bank_income'); ?>">
                        <div class="info-box">
            ...
            if ($this->module_lib->hasActive('ambulance')) {
                if ($this->rbac->hasPrivilege('ambulance_income_widget', 'can_view')) {
                    ?>
                    <div  id="ambulance_title" class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('ambulance_income'); ?>">
                        <div class="info-box">
...
<script type="text/javascript">
    window.onload = function () {
        ...
        $("#opd_title").attr("title",'<?php  print_r("Today Income: ".$today_opd_income)?>'+'\n'+'<?php echo("Cash Income: ".$opd_income_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$opd_income_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$opd_income_upi)?>');
        $("#ipd_title").attr("title",'<?php  print_r("Today Income: ".$today_ipd_income)?>'+'\n'+'<?php echo("Cash Income: ".$ipd_income_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$ipd_income_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$ipd_income_upi)?>');
        $("#pharmacy_title").attr("title",'<?php  print_r("Today Income: ".$today_pharmacy_income)?>'+'\n'+'<?php echo("Cash Income: ".$ipd_pharmacy_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$ipd_pharmacy_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$ipd_pharmacy_upi)?>'+'\n'+'<?php echo("Refund: ".$today_pharmacy_refund)?>');
        $("#pathology_title").attr("title",'<?php  print_r("Today Income: ".$today_pathology_income)?>'+'\n'+'<?php echo("Cash Income: ".$pathology_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$pathology_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$pathology_upi)?>');
        $("#radiology_title").attr("title",'<?php  print_r("Today Income: ".$today_blood_bank_income)?>'+'\n'+'<?php echo("Cash Income: ".$radiology_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$radiology_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$radiology_upi)?>');
        $("#blood_bank_title").attr("title",'<?php  print_r("Today Income: ".$today_radiology_income)?>'+'\n'+'<?php echo("Cash Income: ".$blood_bank_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$blood_bank_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$blood_bank_upi)?>');
        $("#ambulance_title").attr("title",'<?php  print_r("Today Income: ".$today_ambulance_income)?>'+'\n'+'<?php echo("Cash Income: ".$ambulance_income_cash)?>'+'\n'+'<?php echo("Cheque Income: ".$ambulance_income_cheque)?>'+'\n'+'<?php echo("UPI Income: ".$ambulance_income_upi)?>');
