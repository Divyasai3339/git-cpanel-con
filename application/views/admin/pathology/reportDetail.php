                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <?php if ($this->rbac->hasPrivilege('pathology_test', 'can_view')) { ?>   
                                <a data-toggle=""href="<?php echo base_url(); ?>admin/pathology/search"  class="btn btn-primary btn-sm pathology"><i class="fa fa-reorder"></i> <?php echo $this->lang->line(''); ?></a> 
                            <?php } ?>
...
$.ajax({
        url: base_url+'admin/pathology/getallselectedtest',
        type: "POST",
        data: {'ids': selectedID,
                'bill_id' : bill_id
        },
