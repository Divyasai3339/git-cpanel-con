        ...
        <div class="col-md-5">
            <table class="table table-hover table-sm">
              ...
              <tr>
                ...
                <input type="hidden" name="bill_id" id="bill_id"  value="<?php echo $result->id ?>">         
              </tr> 
              <tr>
...
if($report_value->pathology_report != ""){
  ...
  <?php
     ...
     ?>  
      <input type="checkbox" id="<?php echo $report_value->id;?>" name = "chk" value = "<?php echo $report_value->id;?>" />
                               </td>                             
                        </tr>
