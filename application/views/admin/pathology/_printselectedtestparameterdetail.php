            ...
            <div class="card">
                <div class="card-body">  
                    ...
                    <div class="row">
                        ...
                        <div class="pprinta4">
                            <img src="https://drgenielive.com/demo/uploads/printing/1.jpeg" class="img-responsive" style="height:100px; width: 100%;">
                            <?php
                    ...
                    <?php } ?>
                                ...
                                <tr> <th colspan="5"><div class="col-md-6">                       
...
<td colspan="4" style="text-align: center;border-top:1px solid black;"> 
      <strong><?php echo $row->test_name; ?></strong> <br/>
      <?php echo "(".$row->short_name.")"; ?></td>
                                ...
                                <tr class="">
                                   ...
                                   <td class="text-center"><strong><?php echo $this->lang->line('report_value'); ?></strong></td>
