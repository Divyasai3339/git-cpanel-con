<style>
    .sidebar-menu>li:hover>a, .sidebar-menu>li.active>a.chng {
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            <li class="treeview <?php echo set_Topmenu('dashboard'); ?>">
                <a class="chng" href="<?php echo base_url(); ?>admin/admin/dashboard">
            ...
            ?>
                         ...
                         <?php
            if ($this->module_lib->hasActive('medical_camp')) {
                if ($this->rbac->hasPrivilege('medical_camp', 'can_view')) {
            ?>
                    <!--<li class="treeview <?php echo set_Topmenu('medical_camp'); ?>">-->
                    <!--    <a href="<?php echo base_url() ?>admin/medicalcamp/index">-->
                    <!--        <i class="fa fa-eye" aria-hidden="true"></i> <span> <?php echo $this->lang->line('medical_camp'); ?></span>-->
                    <!--    </a>-->
                    <!--</li>-->
            <?php
                }
            ...
            <?php
            if ($this->module_lib->hasActive('optometry')) {
                if ($this->rbac->hasPrivilege('optometry', 'can_view')) {
            ?>
                    <li class="treeview <?php echo set_Topmenu('optometry'); ?>">
                        <a href="<?php echo base_url() ?>admin/optometry">
                            <i class="fa fa-eye" aria-hidden="true"></i> <span> EMR</span>
                        </a>
                    </li>
            <?php
                }
            ...
            <?php
            if ($this->module_lib->hasActive('stores')) {
                if ($this->rbac->hasPrivilege('stores_bill', 'can_view')) {
            ?>
                    <!-- <li class="treeview <?php echo set_Topmenu('stores'); ?>"> -->
                    <!--    <a href="<?php echo base_url(); ?>admin/stores/bill">-->
                    <!--        <i class="fas fa-shopping-cart"></i> <span> <?php echo $this->lang->line('stores'); ?></span>-->
                    <!--    </a>-->
                    <!--</li>-->
            <?php
                }
            ...
            <li class="treeview <?php echo set_Topmenu('pathology'); ?>">
                       ...
                       <a href="<?php echo base_url() ?>admin/pathology/search">
                           <i class="fas fa-microscope"></i> <span><?php echo $this->lang->line('pathology'); ?></span>
                       </a>
                    </li>
            ...
            <li class="treeview <?php echo set_Topmenu('optometry'); ?>">
                        <a href="<?php echo base_url() ?>admin/optometry/counsellingindex">
                            <i class="fa fa-plus-square" aria-hidden="true"></i> <span> Counselling</span>
                        </a>
                    </li>
            ...
            ?>
                    <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->module_lib->hasActive('stores')) {
                                if ($this->rbac->hasPrivilege('stores_bill_report', 'can_view')) {
                                ?><li class="<?php echo set_Submenu('admin/stores/billreport'); ?>"><a href="<?php echo base_url(); ?>admin/stores/billreport"><i class="fas fa-angle-right"></i> <?php echo "Stores Bill Report"; ?></a></li>
                                <?php
                                }
                            }
            ...
            ?>
                <li class="treeview <?php echo set_Topmenu('setup'); ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('notification/setting'); ?>"><a href="<?php echo base_url(); ?>admin/notification/setting"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('settings'); ?></a></li>
                            <?php
                        }
                        if ($this->module_lib->hasActive('patient')) {
                        ...
                        if ($this->module_lib->hasActive('pharmacy')) {
                         ...
                         if ($this->module_lib->hasActive('stores')) {
                            if (($this->rbac->hasPrivilege('product_category', 'can_view') || ($this->rbac->hasPrivilege('product_supplier', 'can_view')) || ($this->rbac->hasPrivilege('product_dosage', 'can_view')))) {
                            ?>
                                <!--<li class="<?php echo set_Submenu('product/index'); ?>"><a href="<?php echo base_url(); ?>admin/productcategory/index"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('stores'); ?></a></li>-->
                            <?php
                            }
                        }
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('finding/index'); ?>"><a href="<?php echo base_url(); ?>admin/complaints"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('complaints'); ?></a></li>
                        <?php
                        }
                        if (($this->rbac->hasPrivilege('finding', 'can_view')) || ($this->rbac->hasPrivilege('finding', 'can_view'))) {
                            ?>
                        ...
                        if ($this->module_lib->hasActive('system_settings')) {
                            ?>
                            <li class="<?php echo set_Submenu('master_data'); ?>"><a href="<?php echo base_url(); ?>admin/masterdata/examinations"><i class="fas fa-angle-right"></i> Master Data</a></li>
                        <?php }
