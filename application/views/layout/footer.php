...
<script type="text/javascript">
    function countDownTimer(opdId){
       
         
        if(localStorage.getItem("total_seconds_"+opdId)){
            $('#timer_btn_'+opdId).hide();
            var total_seconds = localStorage.getItem("total_seconds_"+opdId);
        } else {
            var total_seconds = 360*10;
        }
        ...
        $('#counter_div_'+opdId).text(minutes+":"+seconds)
        //document.getElementById("counter_div_"+opdId).innerHTML = ""+minutes+":"+seconds;
        if(total_seconds <= 0){
            localStorage.removeItem("total_seconds_"+opdId)
            ...
            localStorage.setItem("total_seconds_"+opdId,total_seconds)
            setTimeout("countDownTimer("+opdId+")",1000);
        }
    }
