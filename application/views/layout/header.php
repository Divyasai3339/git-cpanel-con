...
if ($this->customlib->getRTL() == "yes") {
    ?>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/backend/styles/updated_styles.css">
    </head>
    <style>
    th{
     ...
     .btn-primary{
        ...
        .nav navbar-nav headertopmenu{
        color:white !important;
        }
        .nav>li>a, .sidebar-menu>li>a, .treeview-menu>li>a {
        ...
        .sidebar-menu>li>.treeview :hover{
        ...
        .sidebar-menu .treeview-menu :hover {
