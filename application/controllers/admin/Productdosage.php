...
class Productdosage extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_sidebar_menu', 'admin/productdosage');
        $productcategoryid = $this->input->post("productcategoryid");
        $data["title"]      = $this->lang->line('add_product_dosage');
        $productDosage     = $this->product_dosage_model->getProductDosage();

        $unit              = $this->unittype_model->get();
        $data['unit_list'] = $unit;
        $dose_result       = array();
        foreach ($productDosage as $key => $value) {
            $dose_result[$value['product_category_id']][] = $value;
        }
        $data["productDosage"]   = $dose_result;
        ...
        if ($this->form_validation->run()) {
            $productName     = $this->input->post("product_category");
            $productdosageid = $this->input->post("id");

            if (!empty($productdosageid)) {
                $data = array('product_category_id' => $productName, 'dosage' => $this->input->post('dosage'), 'id' => $productdosageid);
            } else {

                $data = array('product_category_id' => $productName, 'dosage' => $this->input->post('dosage'));
            }

            $insert_id = $this->product_dosage_model->addProductDosage($data);
            ...
            $this->load->view("admin/stores/product_dosage", $data);
    ...
    public function interval()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'product/index');
        $this->session->set_userdata('sub_sidebar_menu', 'admin/productdosage/interval');
        $this->load->view("layout/header");
        $this->load->view("admin/stores/dose_interval");
        $this->load->view("layout/footer");
    }
    ...
    public function duration()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'product/index');
        $this->session->set_userdata('sub_sidebar_menu', 'admin/productdosage/duration');
        $this->load->view("layout/header");
        $this->load->view("admin/stores/dose_duration");
        $this->load->view("layout/footer");
    }
    ...
    public function add_interval()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->product_dosage_model->add_interval($data);
    ...
    public function add_duration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->product_dosage_model->add_duration($data);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }
        echo json_encode($array);
    }
    ...
    {
        $result = $this->product_dosage_model->get_intervalbyid($id);
        echo json_encode($result);
    }

    public function get_dosedurationbyid($id)
    {
        $result = $this->product_dosage_model->get_durationbyid($id);
        echo json_encode($result);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $msg = array(
                'product_name' => form_error('product_category'),
            ...
            foreach ($_POST['dosage'] as $key => $value) {
                ...
                $this->product_dosage_model->addProductDosage($data);
            }
    ...
    public function edit($id)
    {
        ...
        $result                   = $this->product_dosage_model->getProductDosage($id);
        $data["result"]           = $result;
    ...
    public function delete($id)
    {
        ...
        $this->product_dosage_model->delete($id);
    ...
    public function getProductDosage()
    {
        $product = $this->input->post('product_id');
        $result   = $this->product_dosage_model->getDosageByProduct($product);
        echo json_encode($result);
    }
    ...
    public function get_doseIntervallist()
    {
        ...
        $dt_response = $this->product_dosage_model->get_doseIntervallist();
    ...
    public function get_dosedurationlist()
    {
        ...
        $dt_response = $this->product_dosage_model->get_dosedurationlist();
    ...
    public function delete_doseInterval($id)
    {
        ...
        $this->product_dosage_model->delete_doseInterval($id);
    }
    ...
    public function delete_doseduration($id)
    {
        ...
        $this->product_dosage_model->delete_doseduration($id);
    }
}
