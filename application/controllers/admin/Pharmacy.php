...
//======================================================================================
    ...
    public function getpharmacypurchaseDatatables()
    {
        $dt_response = $this->pharmacy_model->getAllpharmacypurchaseRecords();
        $dt_response = json_decode($dt_response);
        $dt_data     = array();
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
    ...
    public function get_medicine_stockinfo()
    {
        ...
        $notic_data  = $this->pharmacy_model->get_medicine_stockinfo;
    ...
    public function pharmacyreports()
    {
        ...
        if (!empty($reportdata->data)) {
            foreach ($reportdata->data as $key => $value) {
                ...
                echo
                // $prescription_no = $value->ipd_prescription_basic_id;
    ...
    public function getBatchNumber(){
        ...
        $data=$this->pharmacy_model->getBatchNumberByBatch($batch);
        if($data){
            echo json_encode($data);
        }
        else{
    ...
    public function ip_bill()
    {
        ...
        $data["payment_mode"]     = $this->payment_mode;
        $this->load->view('layout/header');
        $this->load->view('admin/ippharmacy/pharmacyBill', $data);
        $this->load->view('layout/footer');
    }
    ...
    public function ip_search()
    {
        ...
        $medicineCategory         = $this->medicine_category_model->getMedicineCategory();
        $data["medicineCategory"] = $medicineCategory;
        $resultlist               = $this->pharmacy_model->searchIPFullText();

        $i = 0;
        foreach ($resultlist as $value) {
            $pharmacy_id                 = $value['id'];
            $available_qty               = $this->pharmacy_model->totalIPQuantity($pharmacy_id);
            $totalAvailableQty           = $available_qty['total_qty'];
            $resultlist[$i]["total_qty"] = $totalAvailableQty;
            $i++;
        }
        ...
        $data['result']     = $result;
        $this->load->view('layout/header');
        $this->load->view('admin/ippharmacy/search', $data);
        $this->load->view('layout/footer');
    }
    
    public function ip_return_stock()
    {
        if (!$this->rbac->hasPrivilege('medicine_purchase', 'can_view')) {
            access_denied();
        }
        ...
        $supplierCategory         = $this->medicine_category_model->getSupplierCategory();
        $data["supplierCategory"] = $supplierCategory;
        $result                   = $this->pharmacy_model->getIPPharmacy();
        $data['result']           = $result;
        $data["payment_mode"]     = $this->payment_mode;
        $this->load->view('layout/header');
        $this->load->view('admin/ippharmacy/returnStock', $data);
        $this->load->view('layout/footer');
    }
     ...
     public function return_stock()
    {
        ...
        $data["payment_mode"]     = $this->payment_mode;
        $this->load->view('layout/header');
        $this->load->view('admin/pharmacy/returnStock', $data);
        $this->load->view('layout/footer');
    }
    
    public function getIPpharmacypurchaseDatatable()
    {
        $dt_response = $this->pharmacy_model->getAllIPpharmacypurchaseRecord();
        $dt_response = json_decode($dt_response);
        $dt_data     = array();
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
    ...
    public function ip_purchase()
    {
        ...
        $data["payment_mode"]     = $this->payment_mode;
        $this->load->view('layout/header');
        $this->load->view('admin/ippharmacy/purchase', $data);
        $this->load->view('layout/footer');
    }
    
    public function getIPpharmacypurchaseDatatables()
    {
        $dt_response = $this->pharmacy_model->getAllIPpharmacypurchaseRecords();
        $dt_response = json_decode($dt_response);
        $dt_data     = array();
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
    ...
    public function addIPBillSupplier()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $insert_id = $this->pharmacy_model->addIPBillSupplier($data);
            ...
            if ($insert_id) {
                ...
                $this->pharmacy_model->addIPBillMedicineBatchSupplier($data1);
            }
    ...
    public function addIPBillSuppliers()
    {
    ...
    public function addBillSuppliers()
    {
    ...
    public function add_ip()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $insert_id = $this->pharmacy_model->add_ip($pharmacy);
    ...
    public function getIPpharmacyDatatable()
    {
        $dt_response = $this->pharmacy_model->getAllIPpharmacyRecord();
    ...
    public function get_ip_medicine_name()
    {
        $medicine_category_id = $this->input->post("medicine_category_id");
        $data                 = $this->pharmacy_model->get_ip_medicine_name($medicine_category_id);
        echo json_encode($data);
    }
    
    public function getIPBatchNumber(){
        $batch=$this->input->post('batchno');
        $data=$this->pharmacy_model->getIPBatchNumberByBatch($batch);
        if($data){
            echo json_encode($data);
        }
        else{
    ...
    public function getIPSupplierDetails($id)
    {
        ...
        $result         = $this->pharmacy_model->getIPSupplierDetails($id);
        $data['result'] = $result;
        $detail         = $this->pharmacy_model->getIPAllSupplierDetails($id);
        //echo $this->db->last_query();die;
        $data['detail'] = $detail;
        $this->load->view('admin/ippharmacy/printPurchase', $data);
    }
    ...
    public function deleteIPSupplierBill($id)
    {
        ...
        if (!empty($id)) {
            $this->pharmacy_model->deleteIPSupplierBill($id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('delete_message'));
        } else {
            $array = array('status' => 'fail', 'error' => '', 'message' => '');
        }
    ...
    public function getIPDetails()
    {
        ...
        $id     = $this->input->post("pharmacy_id");
        $result = $this->pharmacy_model->getIPDetails($id);
        echo json_encode($result);
    }
    
    public function getIPMedicineBatch()
    {
        if (!$this->rbac->hasPrivilege('medicine', 'can_view')) {
            access_denied();
        }
        $id                     = $this->input->post("pharmacy_id");
        $result                 = $this->pharmacy_model->getIPMedicineBatch($id);
        $data["result"]         = $result;
        $badstockresult         = $this->pharmacy_model->getMedicineBadStock($id);
        $data["badstockresult"] = $badstockresult;
        $this->load->view('admin/ippharmacy/medicineDetail', $data);
    }
    
    public function ip_createBill()
    {
        if (!$this->rbac->hasPrivilege('pharmacy_bill', 'can_view')) {
            access_denied();
        }
        ...
        $page = $this->load->view("admin/ippharmacy/_createBill", $data, true);
        echo json_encode(array('status' => 1, 'page' => $page, 'bill_no' => $bill_no));
    }
    
    public function ip_addBill()
    {
        if (!$this->rbac->hasPrivilege('pharmacy_bill', 'can_add')) {
            access_denied();
        }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($action_type == 'update') {
                ...
                $is_inserted = $this->pharmacy_model->ip_addBill($bill_detail, $insert_medicines, $update_medicines, $delete_result, $payment_array);
                ...
                $is_inserted = $this->pharmacy_model->ip_addBill($bill_detail, $insert_medicines, array(), array(), $payment_array);
    ...
    public function ip_getpharmacybillDatatable()
    {
        $dt_response = $this->pharmacy_model->ip_getAllpharmacybillRecord();
    ...
    public function ip_get_medicine_name()
    {
        $medicine_category_id = $this->input->post("medicine_category_id");
        $data                 = $this->pharmacy_model->ip_get_medicine_name($medicine_category_id);
        echo json_encode($data);
    }
    
    public function ip_getBatchNoList()
    {
        $pharmacy_id = $this->input->get_post('pharmacy_id');
        $result      = $this->pharmacy_model->ip_getBatchNoList($pharmacy_id);

        echo json_encode($result);
    }
    
    public function ip_getExpiryDate()
    {
        $medicine_batch_detail_id = $this->input->get_post('medicine_batch_detail_id');
        $result                   = $this->pharmacy_model->ip_getMedicineBatchByID($medicine_batch_detail_id);

        $result->expiry_date = $this->customlib->getMedicine_expire_month($result->expiry);
        echo json_encode($result);
    }
    
    public function ip_getPharmacyTransaction()
    {
        $pharmacy_bill_basic_id         = $this->input->post('id');
        $pharmacy_bill_detail           = $this->pharmacy_model->ip_getBillDetails($pharmacy_bill_basic_id);
        $balance_amount                 = ($pharmacy_bill_detail['net_amount'] - $pharmacy_bill_detail['paid_amount']);
        $pharmacy_transaction           = $this->transaction_model->ip_pharmacyPayments($pharmacy_bill_basic_id);
        $data["balance_amount"]         = amountFormat($balance_amount);
        $data["pharmacy_bill_basic_id"] = $pharmacy_bill_basic_id;
        $data["payment_mode"]           = $this->payment_mode;
        $data['pharmacy_transaction']   = $pharmacy_transaction;
        ...
        $page = $this->load->view("admin/ippharmacy/_getPharmacyTransaction", $data, true);
        echo json_encode(array('status' => 1, 'page' => $page));
    }
    
    public function ip_getBillDetails()
    {
        if (!$this->rbac->hasPrivilege('pharmacy_bill', 'can_view')) {
            access_denied();
        }
        ...
        $result = $this->pharmacy_model->getIpBillDetails($id, $data['check_print']);
        $data['result'] = $result;
        $bill_no    = $result['id'];
        $patient_id = $result['patient_id'];
        $ipd_prescription_basic_id = $result['ipd_prescription_basic_id'];        
        ...
        $detail = $this->pharmacy_model->ip_getAllBillDetails($id);
        $data['detail'] = $detail;
        $action_details = "";
        if ($this->rbac->hasPrivilege('pharmacy_bill', 'can_view')) {
            $action_details .= "<a href='#'  data-loading-text='<i class=\"fa fa-circle-o-notch fa-spin\"></i>' data-toggle='tooltip' class='" . $bill_print . "' data-record-id='" . $id . "' data-original-title='" . $this->lang->line('print') . "'><i class='fa fa-print'></i></a>";
        ...
        $page = $this->load->view('admin/ippharmacy/_getBillDetails', $data, true);
        echo json_encode(array('status' => 1, 'page' => $page, 'actions' => $action_details));
    }
    
    public function ip_editBill()
    {
        if (!$this->rbac->hasPrivilege('pharmacy_bill', 'can_view')) {
            access_denied();
        }
        ...
        $doctors                     = $this->staff_model->getStaffbyrole(3);
        $data["doctors"]             = $doctors;
        $bill                        = $this->pharmacy_model->getIpBillDetails($id);
        $data['bill']                = $bill;
        $detail                      = $this->pharmacy_model->ip_getAllBillDetails($id);
        $data['detail']              = $detail;
        $data["payment_mode"]        = $this->payment_mode;
        $data['custom_fields_value'] = display_custom_fields('pharmacy', $id);
        $page = $this->load->view("admin/ippharmacy/_editBill", $data, true);
        $total_rows = count($detail); 
        echo json_encode(array('status' => 1, 'page' => $page, 'paid_amount' => $bill['paid_amount'], 'patient_id' => $bill['patient_id'], 'patient_name' => $bill['patient_name'], 'bill_no' => $this->customlib->getSessionPrefixByType('pharmacy_billing').$bill['id'], 'date' => $bill['date'], 'case_reference_id' => $bill['case_reference_id'], 'total_rows' => $total_rows));
    }
    
    public function ip_deletePharmacyBill()
    {
        $id = $this->input->post('id');
        if (!$this->rbac->hasPrivilege('pharmacy_bill', 'can_delete')) {
            access_denied();
        ...
        if (!empty($id)) {
            $this->pharmacy_model->ip_deletePharmacyBill($id);
            $array = array('status' => 1, 'error' => '', 'message' => $this->lang->line('delete_message'));
        } else {
            $array = array('status' => 0, 'error' => '', 'message' => $this->lang->line('something_went_wrong'));
        }
