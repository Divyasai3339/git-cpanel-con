...
class Operationtheatre extends Admin_Controller
{
    ...
    public function addipdot()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $operation_detail = array(
                ...
                'iol_name'            => $this->input->post('iol_name'),
                'iol_model'            => $this->input->post('iol_model'),
                'batch_no'            => $this->input->post('batch_no'),
                'iol_type'            => $this->input->post('iol_type'),
                'axial_length'            => $this->input->post('axial_length'),
                'a_constant'            => $this->input->post('a_constant'),
                'power'            => $this->input->post('power'),
                'optin_dioptor'            => $this->input->post('optin_dioptor'),
                'ac_pc'            => $this->input->post('ac_pc'),
    ...
    // MY EXTRA OPERATION CODE
    
   // iolmodel Length
    
    public function iolmodel()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['iolmodel_list'] = $this->operationtheatre_model->iolmodel_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/iolmodel', $data);
        $this->load->view('layout/footer');

    }
    public function addiolmodel()
    {
        $this->form_validation->set_rules('iolmodel_name', $this->lang->line('iolmodel_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('iolmodel_name'),
            );
            ...
            if ($id != "") {
                $data = array('iolmodel_name' => $this->input->post('iolmodel_name'));

            } else {
                $data = array('iolmodel_name' => $this->input->post('iolmodel_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertiolmodel($data, 'iolmodel', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }

        echo json_encode($array);
    }
    public function getiolmodel($id)
    {
        $result = $this->operationtheatre_model->iolmodel_list($id);
        echo json_encode($result);
    }

    public function deleteiolmodel()
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_iolmodel($id);
    }
       ...
       public function ioltype()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['ioltype_list'] = $this->operationtheatre_model->ioltype_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/ioltype', $data);
        $this->load->view('layout/footer');

    }
    public function addioltype()
    {
        $this->form_validation->set_rules('ioltype_name', $this->lang->line('ioltype_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('ioltype_name'),
            );
            ...
            if ($id != "") {
                $data = array('ioltype_name' => $this->input->post('ioltype_name'));

            } else {
                $data = array('ioltype_name' => $this->input->post('ioltype_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertiol($data, 'ioltype', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }

        echo json_encode($array);
    }
    public function getioltype($id)
    {
        $result = $this->operationtheatre_model->ioltype_list($id);
        echo json_encode($result);
    }

    public function deleteioltype()
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_ioltype($id);
    }
    ...
    public function axial()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['axial_list'] = $this->operationtheatre_model->axial_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/axial', $data);
        $this->load->view('layout/footer');

    }
    public function addaxial()
    {
        $this->form_validation->set_rules('axial_name', $this->lang->line('axial_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('axial_name'),
            );
            ...
            if ($id != "") {
                $data = array('axial_name' => $this->input->post('axial_name'));

            } else {
                $data = array('axial_name' => $this->input->post('axial_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertaxial($data, 'axial', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }

        echo json_encode($array);
    }
    public function getaxial($id)
    {
        $result = $this->operationtheatre_model->axial_list($id);
        echo json_encode($result);
    }

    public function deleteaxial()
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_axial($id);
    }
    ...
    public function constant()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['constant_list'] = $this->operationtheatre_model->constant_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/constant', $data);
        $this->load->view('layout/footer');

    }
    public function addconstant()
    {
        $this->form_validation->set_rules('constant_name', $this->lang->line('constant_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('constant_name'),
            );
            ...
            if ($id != "") {
                $data = array('constant_name' => $this->input->post('constant_name'));

            } else {
                $data = array('constant_name' => $this->input->post('constant_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertconstant($data, 'constant', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }
    ...
    {
        $result = $this->operationtheatre_model->constant_list($id);
        echo json_encode($result);
    }
    ...
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_constant($id);
    }
    ...
    public function power()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['power_list'] = $this->operationtheatre_model->power_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/power', $data);
        $this->load->view('layout/footer');

    }
    public function addpower()
    {
        $this->form_validation->set_rules('power_name', $this->lang->line('power_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('power_name'),
            );
            ...
            if ($id != "") {
                $data = array('power_name' => $this->input->post('power_name'));

            } else {
                $data = array('power_name' => $this->input->post('power_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertpower($data, 'power', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }
    ...
    {
        $result = $this->operationtheatre_model->power_list($id);
        echo json_encode($result);
    }
    ...
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_power($id);
    }
    ...
    public function optin()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['optin_list'] = $this->operationtheatre_model->optin_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/optin', $data);
        $this->load->view('layout/footer');

    }
    public function addoptin()
    {
        $this->form_validation->set_rules('optin_name', $this->lang->line('optin_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('optin_name'),
            );
            ...
            if ($id != "") {
                $data = array('optin_name' => $this->input->post('optin_name'));

            } else {
                $data = array('optin_name' => $this->input->post('optin_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertoptin($data, 'optin', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }
    ...
    {
        $result = $this->operationtheatre_model->optin_list($id);
        echo json_encode($result);
    }
   ...
   public function deleteoptin()
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_optin($id);
    }
    ...
    public function acpc()
    {
        ...
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['acpc_list'] = $this->operationtheatre_model->acpc_list();
        $this->load->view('layout/header');
        $this->load->view('admin/operationtheatre/acpc', $data);
        $this->load->view('layout/footer');

    }
    public function addacpc()
    {
        $this->form_validation->set_rules('acpc_name', $this->lang->line('acpc_name'), 'required');
        $id = $this->input->post('id');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'name' => form_error('acpc_name'),
            );
            ...
            if ($id != "") {
                $data = array('acpc_name' => $this->input->post('acpc_name'));

            } else {
                $data = array('acpc_name' => $this->input->post('acpc_name'), 'created_at' => date('Y-m-d'));

            }

            $this->operationtheatre_model->insertacpc($data, 'acpc', $id);
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message'));
        }

        echo json_encode($array);
    }
    public function getacpc($id)
    {
        $result = $this->operationtheatre_model->acpc_list($id);
        echo json_encode($result);
    }

   public function deleteacpc()
    {
        $id = $_REQUEST['id'];
        $this->operationtheatre_model->delete_acpc($id);
    }
