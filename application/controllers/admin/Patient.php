...

{
    ...
    public function patient_status_list(){



        if (!$this->rbac->hasPrivilege('patient_status', 'can_view')) {
        ...
        $this->load->view('admin/bill/opd/status_list', $data);
...

    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $patient_data = array(
                ...
                'biohazard'                => $this->input->post('biohazard'),
...
echo '<pre>';print_r($visit_data);echo '</pre>';die;
...

    {
      ...
      public function getMedCampData()
        ...
        public function printConsentform()
    {
        $type                  = $this->input->post('type');
        $print_details         = $this->printing_model->get('', 'opd');
        // $id                    = $this->input->post('id');
        echo '<pre>';print_r($id);echo '</pre>';die;
        $opddata                  = $this->patient_model->getVisitDetailsbyopdid($id);
        $data['opddata']        = $opddata;
        ...
        $page                  = $this->load->view('admin/patient/_printConsentform', $data, true);
        echo json_encode(array('status' => 1, 'page' => $page));
    }
