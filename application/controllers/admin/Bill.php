...
class Bill extends Admin_Controller
{
    ...
    public function add_discharge()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'clinical_findings'                => $this->input->post('clinical_findings'),
                // 'bp'                => $this->input->post('bp'),
                'rbs_fbs'                => $this->input->post('rbs_fbs'),
                'duct_syringing'                => $this->input->post('duct_syringing'),
                'od_os'                => $this->input->post('od_os'),
     ...
     public function print_dischargecard()
    {
        ...
        $operation_theatre          = $this->operationtheatre_model->getipdoperationDetailsPrint($ipd_id);
        // print_r($operation_theatre);die;
        ...
        $result1               = $this->patient_model->getIpdDetailsdischarge($ipd_id);
        ...
        $action = '<a href="javascript:void(0);" class="print_dischargecard" data-toggle="tooltip" title="" data-module_type="' . $type . '" data-case_id="' . $case_id . '" data-recordId="' . $id . '" data-ipd_id="' . $ipd_id . '"data-original-title=""><i class="fa fa-print"></i> </a>' . $download;
...
//=============pathology=====================
    ...
    //     $dt_response = $this->patient_model->getAllpatientStatusRecord();
    ...
    //             $status_term_arr=['waiting'=>'#fcba03','ar'=>'#d0deb1','optom'=>'#b1dade','doctor'=>'#14858f','dilation'=>'#5f64e8','investigation'=>'#bf7411','checkedout'=>'#ff0000','not_available'=>'#db0f20'];
    //             $str='';
    //             $investigatin_json=(isset($value->investigate_json))?$value->investigate_json:'';
                
    //             $isInvestigation=false;
    //             if($investigatin_json!='')
    //             {
    //                 $investigatin_json=json_decode('['.$investigatin_json.']');

    //                 if(isset($investigatin_json) && is_array($investigatin_json))
    //                 {
    //                     $obj_arr=$investigatin_json;
    //                     if(isset($obj_arr))
    //                     {
    //                       foreach($obj_arr as $kk=>$rr)
    //                       {
    //                         $rr->id=$value->opdid;
    //                         if(isset($rr->as_investigations_od) && !empty($rr->as_investigations_od))
    //                         {
    //                           //log_message('error', json_encode($rr->as_investigations));    
    ...
    //                 }
    //             }
    //             foreach($status_term_arr as $k=>$v)
    //             {
    //               if($k=='investigation' && $isInvestigation==false)
    //               {
    //                  $v='';
    //               }
    //               if($k=='ar' && $value->artime=='')
    //               {
    //                  $v='';
    //               }
    //               if($k=='optom' && $value->optime=='')
    //               {
    //                  $v='';
    //               }
    //               if($k=='doctor' && $value->doctime=='')
    //               {
    //                  $v='';
    //               }
    //               if($k=='dilation' && $value->dailation=='')
    //               {
    //                  $v='';
    //               }
    //               $html_elem='<div class="div_red status_div" style="background-color:'.$v.';"></div>';

    //               if($k=='checkedout' && (int)$value->is_checkdout===0)
    //               {
    //                  $v='';
    //                  $html_elem='<input type="checkbox" class="status_div patient_checkout" data-id="'.$value->opdid.'" style="margin:0px;">';
    //               }
    //               if($k=='checkedout' && (int)$value->is_checkdout!=0)
    //               {
    //                 $html_elem='<input type="checkbox" class="status_div abc" style="margin:0px;" checked disabled>';
    //               }
    //               if($k=='not_available' && (int)$value->not_avialable===0)
    //               {
    //                  $v='';
    //                   $html_elem='';
    //                   if((int)$value->is_checkdout===0)
    //                   {
    //                     $html_elem='<input type="checkbox" class="status_div patient_not_avail" data-id="'.$value->opdid.'"  style="margin:0px;">';
    //                   }
    ...
    //                  if((int)$value->is_checkdout===0)
    //                  {
    //                   $html_elem='<input type="checkbox" class="status_div patient_avail" data-id="'.$value->opdid.'"  style="margin:0px;color:red !important;" checked>'; 
    //                  }
                    
    //               }

    //               $str.='<a data-toggle="tooltip" title="" data-original-title="'.ucfirst($k).'">
    //                         <div class="progress">
    //                         '.$html_elem.'
    //                         </div>
    //                       </a>'; 
    //             }
    //             $status_div='<div class="d-flex justify-content-around">'.$str.'</div>';
    //             //==============================
    //             $li='<li><a href="#" class="patient_not_avail" data-id="'.$value->opdid.'">Not Available</a></li>';
    //             if($value->not_avialable!=0)
    //             {
    //               $li='<li><a href="#" class="patient_avail" data-id="'.$value->opdid.'">Available</a></li>';
    //             }
    //             if((int)$value->is_checkdout===0)
    //             {
    //               $li.='<li><a href="#" class="patient_checkout" data-id="'.$value->opdid.'">Checkout</a></li>';  
    //             }
                
    //             $row[] = $first_action . $value->patient_name . "</a>";
    //             $row[] = $value->mobileno;
    //             $row[] = $value->report_time;
    //             $row[] = $value->visis_id;
    //             $row[] = $value->charge_name;
    //             $row[] = composeStaffNameByString($value->name, $value->surname, $value->employee_id);
    ...
    //     echo json_encode($json_data);
    // }
    // public function updatePatientStatusCnt(){


    //     $opd_details_id=$this->input->post('opd_id');
    //     $action=$this->input->post('action');
    //     $column='';
    //     $condition=['opd_details_id'=>$opd_details_id];
    //     $update_value=null;
    //     if($action=='checkout')
    //     {
    //         $column='is_checkdout';
    ...
    //     {
    //         $column='dailation'; 
    //         $update_value=date('Y-m-d H:i:s');
    //     }
    //     $data=[$column=>$update_value];
        
    //     $result=$this->patient_model->updatePatientStatus($condition,$data);
    //     $msg=($result)?'Status update success':'Status update failed';
 ...
 $status_term_arr=['waiting'=>'#fcba03','ar'=>'#FF0000','optom'=>'blue','doctor'=>'#720455','investigation'=>'#0C7B93','checkedout'=>'#ff0000','not_available'=>'#db0f20'];
                $str='';
                $investigatin_json=(isset($value->investigate_json))?$value->investigate_json:'';
                ...
                foreach($status_term_arr as $k=>$v)
                {
                   ...
                   if($k=='not_available' && (int)$value->not_avialable!=0)
                   {
                     ...
                     if((int)$value->is_checkdout===0)
                     {
                       $html_elem='<input type="checkbox" class="status_div patient_avail" data-id="'.$value->opdid.'"  style="margin:0px; accent-color:red !important;" checked>'; 
                     }
...
//=========================
    ...
    // prep code
    public function patient_prep($case_id)
    {
        $data['case_id']        = $case_id;
        $patient                = $this->patient_model->getDetailsByCaseId($case_id);
        $type                   = $this->input->post('module_type');
        $data['discharge_prep'] = $this->patient_model->get_prep(array('case_reference_id' => $case_id));
        ...
        // }
        $data['death_status'] = $this->customlib->discharge_status();
        $page                 = $this->load->view('admin/bill/_patient_prep', $data, true);
        echo json_encode(array('status' => 1, 'page' => $page));
    }
    ...
    public function add_prep()
    {
            ...
            $surgery_date  = $this->customlib->dateFormatToYYYYMMDDHis($this->input->post("surgery_date"));
            ;
            if ($surgery_date == "") {
                $surgery_date = null;
            } else {
            ...
            $surgery_date_left  = $this->customlib->dateFormatToYYYYMMDDHis($this->input->post("surgery_date_left"));
            ;
            if ($surgery_date_left == "") {
                $surgery_date_left = null;
            } else {
                $surgery_date_left = $this->customlib->dateFormatToYYYYMMDD($surgery_date_left);
            }

            $data = array(
                'id'                  => $this->input->post('id'),
                'case_reference_id'   => $this->input->post('case_reference_id'),
                'r_vision'                => $this->input->post('r_vision'),
                'l_vision'                => $this->input->post('l_vision'),
                'r_ant'                => $this->input->post('r_ant'),
                'l_ant'                => $this->input->post('l_ant'),
                'r_dil'                => $this->input->post('r_dil'),
                'l_dil'                => $this->input->post('l_dil'),
                'r_fun'                => $this->input->post('r_fun'),
                'l_fun'                => $this->input->post('l_fun'),
                'r_ar'                => $this->input->post('r_ar'),
                'l_ar'                => $this->input->post('l_ar'),
                'r_iop'                => $this->input->post('r_iop'),
                'l_iop'                => $this->input->post('l_iop'),
                'r_sac'                => $this->input->post('r_sac'),
                'l_sac'                => $this->input->post('l_sac'),
                'r_bp'                => $this->input->post('r_bp'),
                'l_bp'                => $this->input->post('l_bp'),
                'r_blo'                => $this->input->post('r_blo'),
                'l_blo'                => $this->input->post('l_blo'),
                'r_k1'                => $this->input->post('r_k1'),
                'l_k1'                => $this->input->post('l_k1'),
                'r_k2'                => $this->input->post('r_k2'),
                'l_k2'                => $this->input->post('l_k2'),
                'r_ac'                => $this->input->post('r_ac'),
                'l_ac'                => $this->input->post('l_ac'),
                'r_len'                => $this->input->post('r_len'),
                'l_len'                => $this->input->post('l_len'),
                'r_axi'                => $this->input->post('r_axi'),
                'l_axi'                => $this->input->post('l_axi'),
                'r_iol'                => $this->input->post('r_iol'),
                'l_iol'                => $this->input->post('l_iol'),
                'r_ope'                => $this->input->post('r_ope'),
                'l_ope'                => $this->input->post('l_ope'),
                'ho'                => $this->input->post('ho'),
                'surgery_date'                => $surgery_date,
                'surgery_date_left'                => $surgery_date_left,
            ...
            $insert_id = $this->patient_model->add_prep($data);
            print_r($data);die;
    ...
    public function print_prep()
    {
        ...
        $result1               = $this->patient_model->getIpdDetailsprep($ipd_id);
        $data['result1']  = $result1;
        ...
        $action = '<a href="javascript:void(0);" class="print_prep" data-toggle="tooltip" title="" data-module_type="' . $type . '" data-case_id="' . $case_id . '" data-recordId="' . $id . '" data-ipd_id="' . $ipd_id . '"data-original-title=""><i class="fa fa-print"></i> </a>' . $download;

        // echo '<pre>';
        //        print_r($data);die;

        $page   = $this->load->view('admin/bill/_printprep', $data, true);
        echo json_encode(array('status' => 1, 'page' => $page, 'action' => $action));
    }

     // prep code
     public function patient_consent($case_id)
     {
         $data['case_id']        = $case_id;
         $patient                = $this->patient_model->getDetailsByCaseId($case_id);
         $type                   = $this->input->post('module_type');
         $data['discharge_consent'] = $this->patient_model->get_consent(array('case_reference_id' => $case_id));
         ...
         $data['guardian_name']  = $patient['guardian_name'];
         $data['death_status'] = $this->customlib->discharge_status();
         $page                 = $this->load->view('admin/bill/_patient_consent', $data, true);
         echo json_encode(array('status' => 1, 'page' => $page));
     }
     ...
     public function add_consent()
     {
            ...
            //      $surgery_date = $this->customlib->dateFormatToYYYYMMDD($surgery_date);
            //  }
            //  echo '<pre>';print_r($surgery_date);echo '</pre>';die;
 
             $data = array(
                 'id'                  => $this->input->post('id'),
                 'case_reference_id'   => $this->input->post('case_reference_id'),
                 'surgeon_name'                => $this->input->post('surgeon_name'),
                 'kmc_no'                => $this->input->post('kmc_no'),
                 'surgery_date'                => $surgery_date,
            ...
            //  print_r($data);die;
             ...
             $insert_id = $this->patient_model->add_consent($data);
            //  print_r($data);die;
     ...
     public function print_consent()
     {
         ...
         $result1               = $this->patient_model->getIpdDetailsconsent($ipd_id);
         $data['result1']  = $result1;
...
//  echo '<pre>';print_r($data);echo '</pre>';die;
         ...
         $action = '<a href="javascript:void(0);" class="print_consent" data-toggle="tooltip" title="" data-module_type="' . $type . '" data-case_id="' . $case_id . '" data-recordId="' . $id . '" data-ipd_id="' . $ipd_id . '"data-original-title=""><i class="fa fa-print"></i> </a>' . $download;
 
        //  echo '<pre>';
        //         print_r($data);die;
 
         $page   = $this->load->view('admin/bill/_print_consent', $data, true);
         echo json_encode(array('status' => 1, 'page' => $page, 'action' => $action));
     }
