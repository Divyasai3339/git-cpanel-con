...
class Notificationsetting_model extends MY_Model
{
    ...
    public function getproductcategoryDetails($id){
        return  $this->db->select('product_category')->from('product_category')->where('id',$id)->get()->row_array();
    }

    public function getproductDetails($id){
        return  $this->db->select('product_name')->from('stores')->where('id',$id)->get()->row_array();
    }
