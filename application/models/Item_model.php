...
class Item_model extends MY_Model
{
    ...
    public function getProducteName()
    {
        $query = $this->db->select('stores.id,stores.medicine_name')->get('stores');
        return $query->result_array();
    }
    ...
    public function getAllstorebillRecord()
    {
    ...
    {
        $this->db->select('stores.*,product_category.id as medicine_category_id,product_category.medicine_category');
        $this->db->join('product_category', 'stores.medicine_category_id = product_category.id', 'left');
        $this->db->where('`stores`.`medicine_category_id`=`product_category`.`id`');
        $this->db->order_by('stores.medicine_name');
